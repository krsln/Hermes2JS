...
from hermes_decompiler.transforms.structurers.if_structurer._compound_folder import _CompoundConditionFolder
from hermes_decompiler.transforms.structurers.if_structurer._dominance_builder import _DominanceIfBuilder
