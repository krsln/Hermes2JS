function onPress(param0) {
    ...
    if (r2) {
        ...
        r2 = r3[r2].trackJoinCompetitionList.call(this, )
        ...
        r2 = r2.default.call(this, { message: "You have joined the list", type: "success" })
        ...
        r2 = r2.default.setItem.call(this, "compjoin", "true")
    ...
    r0 = r0.default.open.call(this, { title: "Join Coachify AI Competition", message: "Join Coachify AI Competition", url: "https://coachify.ai/download?ref=compshare", subject: "Join Coachify AI Competition" })
