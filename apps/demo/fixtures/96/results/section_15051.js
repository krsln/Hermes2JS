function function_15051(param0, param1, param2) {
    // ──────────────── Block 0 ──────────────── 
    ...
    if (param2 === 2) {
        ...
        // CODE → <LoadConstString>: <Reg8: 1, string_id: 4537>  # String: '__BC:ControlFlow/ForEachTests/forEachTest/if-middle' (String)
        ...
        // CODE → <LoadConstString>: <Reg8: 0, string_id: 8291>  # String: 'middle' (Identifier)
        // USED → r0 = "middle";
