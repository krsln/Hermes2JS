function function_15171(param1, param2, param3, param4, param5, param6, param7) {
    ...
    // USED → r0 = _simpleAsyncTest(param0);
    // CODE → <StoreToEnvironment>: <Reg8: 2, UInt8: 4, Reg8: 0>
    createEnvironment()[4] = _simpleAsyncTest(param0)
    ...
    // USED → r7 = asyncTryCatchTest(param0);
    // CODE → <StoreToEnvironment>: <Reg8: 2, UInt8: 5, Reg8: 7>
    createEnvironment()[5] = asyncTryCatchTest(param0)
    ...
    // USED → r0 = parallelAwaitTest(param0);
    // CODE → <StoreToEnvironment>: <Reg8: 2, UInt8: 9, Reg8: 0>
    createEnvironment()[9] = parallelAwaitTest(param0)
