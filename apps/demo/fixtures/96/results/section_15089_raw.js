function loopBreakCrossesTryBoundaryTest(param0, param1) {
    ...
    // CODE → <JNotLessLong>: <Addr32: 171, Reg8: 7, Reg8: 2>  # Address: 000000e0
    if (!(0 < param1.length)) goto label_224;
    // ──────────────── Block 1 ──────────────── 
    ...
    if (r2 + 1 < param1.length) goto label_60;
    // ──────────────── Block 6 ──────────────── 
