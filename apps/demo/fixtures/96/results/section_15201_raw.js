function function_15201(param0, param1) {
    ...
    // USED → r4 = Dog(param0, param1, param2);
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 0, Reg8: 4>
    createEnvironment()[0] = Dog(param0, param1, param2)
    ...
    r2 = getEnvironment(0)[2].default.call(undefined, Dog(param0, param1, param2), r2)
    ...
    // USED → r0 = getEnvironment(0)[4].default.call(undefined, Dog(param0, param1, param2), r1, r0);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[4].default.call(undefined, Dog(param0, param1, param2), r1, r0);
}