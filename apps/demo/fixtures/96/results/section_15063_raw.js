function ifElseChainTest(param1, param2) {
    ...
    // CODE → addr: 28 | <JmpFalse>: <Addr8: 6, Reg8: 1>  # Address: 00000022
    if (!param1) goto label_34;
    // ──────────────── Block 1 ──────────────── 
    // CODE → addr: 31 | <JmpTrue>: <Addr8: 93, Reg8: 2>  # Address: 0000007c
    if (param2) goto label_124;
    // ──────────────── Block 2 ──────────────── 
    // CODE → addr: 34 | <JmpTrue>: <Addr8: 48, Reg8: 1>  # Address: 00000052
    if (param1) goto label_82;
    // ──────────────── Block 3 ──────────────── 
    // CODE → addr: 37 | <JmpTrue>: <Addr8: 45, Reg8: 2>  # Address: 00000052
    ...
    console.log("both")
    // ──────────────── Block 7 ──────────────── 
    // CODE → addr:164 | <JmpTrue>: <Addr8: 43, Reg8: 1>  # Address: 000000cf
