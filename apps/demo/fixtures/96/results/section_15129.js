function nestedTemplateTest(param0, param1, param2) {
    ...
    r3 = globalThis.console.log("__BC:Strings/TemplateLiteralTests/nestedTemplateTest/start")
    // CODE → <Add>: <Reg8: 4, Reg8: 2, Reg8: 1>
    // USED → r4 = param1 + param2;
    // CODE → <LoadConstUInt8>: <Reg8: 3, UInt8: 10>
    // USED → r3 = (param1 + param2 <= 10) ? 10 : globalThis.HermesInternal.concat.call("big (", param1 + param2, ")");
    // ──────────────── Block 3 ──────────────── 
    ...
    // USED → r3 = globalThis.HermesInternal.concat.call("sum is ", (param1 + param2 <= 10) ? 10 : globalThis.HermesInternal.concat.call("big (", param1 + param2, ")"));
    // CODE → <TryGetById>: <Reg8: 2, Reg8: 0, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r2 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 1, Reg8: 2, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r1 = globalThis.console.log;
    // CODE → <Call2>: <Reg8: 1, Reg8: 1, Reg8: 2, Reg8: 3>
    r1 = globalThis.console.log(globalThis.HermesInternal.concat.call("sum is ", (param1 + param2 <= 10) ? 10 : globalThis.HermesInternal.concat.call("big (", param1 + param2, ")")))
    // CODE → <TryGetById>: <Reg8: 2, Reg8: 0, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r2 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 1, Reg8: 2, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r1 = globalThis.console.log;
    ...
    r0 = globalThis.console.log("__BC:Strings/TemplateLiteralTests/nestedTemplateTest/end")
