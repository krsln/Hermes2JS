function Dog(param0, param1, param2) {
    ...
    // CODE → <GetByIdShort>: <Reg8: 1, Reg8: 1, UInt8: 1, string_id: 108>  # String: 'default' (Identifier)
    ...
    // CODE → <GetByIdShort>: <Reg8: 1, Reg8: 0, UInt8: 1, string_id: 108>  # String: 'default' (Identifier)
    ...
    // USED → r0 = [param1];
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 4287>  # String: 'Woof' (String)
    // USED → r5 = "Woof";
    // CODE → <PutOwnByIndex>: <Reg8: 0, Reg8: 5, UInt8: 1>
    // USED → r0 = [param1, "Woof"];
    // CODE → <Call4>: <Reg8: 0, Reg8: 1, Reg8: 2, Reg8: 4, Reg8: 3, Reg8: 0>
    // USED → r0 = getEnvironment(1)[0].default.call(undefined, this, getEnvironment(0)[0], [param1, "Woof"]);
    // CODE → <GetGlobalObject>: <Reg8: 1>
    // USED → r1 = globalThis;
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 2, string_id: 100>  # String: 'console' (Identifier)
    // USED → r3 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 3, string_id: 91>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 2852>  # String: '__BC:Classes/ClassTests/Dog/constructor' (String)
    ...
    // USED → r1 = param2;
    // CODE → <PutById>: <Reg8: 0, Reg8: 1, UInt8: 1, string_id: 16498>  # String: 'breed' (Identifier)
    getEnvironment(1)[0].default.call(undefined, this, getEnvironment(0)[0], [param1, "Woof"]).breed = param2
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(1)[0].default.call(undefined, this, getEnvironment(0)[0], [param1, "Woof"]);
}