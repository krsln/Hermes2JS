function callAsyncTests(param0) {
    ...
    // USED → r0 = getEnvironment(0)[11].apply(this, arguments);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[11].apply(this, arguments);
}