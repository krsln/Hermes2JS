function arrayTest(param0) {
    ...
    console.log(r6.sort(function_15111))
    ...
    // USED → r2 = globalThis.console.log;
    // CODE → <Call2>: <Reg8: 2, Reg8: 2, Reg8: 3, Reg8: 6>
    console.log(r4.map(function_15112))
    ...
    // USED → r2 = globalThis.console.log;
    // CODE → <Call2>: <Reg8: 2, Reg8: 2, Reg8: 3, Reg8: 6>
    console.log(r4.filter(function_15113))
    ...
    console.log(r4.reduce(function_15114, 0))
    ...
    console.log(r4.find(function_15115))
