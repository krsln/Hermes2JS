function tryFinallyNormalCompletionTest() {
    ...
    // USED → r2 = console.log;
    // CODE → addr: 13 | <LoadConstString>: <Reg8: 0, string_id: 4745>  # String: '__BC:Exceptions/ExceptionTests/tryFinallyNormalCompletionTest/start' (String)
    ...
    // USED → r2 = console.log;
    // CODE → addr: 33 | <LoadConstString>: <Reg8: 0, string_id: 4746>  # String: '__BC:Exceptions/ExceptionTests/tryFinallyNormalCompletionTest/try-block' (String)
    ...
    // CODE → addr: 42 | <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r3 = console;
    // CODE → addr: 48 | <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r2 = console.log;
    // CODE → addr: 53 | <LoadConstString>: <Reg8: 0, string_id: 4744>  # String: '__BC:Exceptions/ExceptionTests/tryFinallyNormalCompletionTest/finally-block' (String)
    ...
    // USED → r2 = console.log;
    // CODE → addr: 99 | <LoadConstString>: <Reg8: 1, string_id: 4744>  # String: '__BC:Exceptions/ExceptionTests/tryFinallyNormalCompletionTest/finally-block' (String)
