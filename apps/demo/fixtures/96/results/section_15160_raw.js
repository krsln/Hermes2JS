function restAfterRequiredTest(param0, param1, param2) {
    ...
    r2 = 0
    // CODE → <JmpFalse>: <Addr8: 7, Reg8: 6>  # Address: 00000033
    ...
    // USED → r2 = 2;
    // CODE → <JmpFalse>: <Addr8: 22, Reg8: 7>  # Address: 00000067
    ...
    if (r2 + 1 < arguments.length) goto label_84;
    // ──────────────── Block 4 ──────────────── 
    ...
    console.log(param1, param2, new Array(arguments.length - 2))
