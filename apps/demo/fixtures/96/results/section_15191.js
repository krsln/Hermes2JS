function _callAsyncTests(param0) {
    // ──────────────── Block 0 ──────────────── 
    ...
    // USED → r3 = getEnvironment(0)[1].default.call(undefined, function_15192);
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 11, Reg8: 3>
    getEnvironment(0)[11] = getEnvironment(0)[1].default.call(undefined, function_15192)
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 65>  # String: 'apply' (Identifier)
    // USED → r2 = getEnvironment(0)[1].default.call(undefined, function_15192).apply;
    ...
    // USED → r0 = getEnvironment(0)[1].default.call(undefined, function_15192).apply(this, arguments);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[1].default.call(undefined, function_15192).apply(this, arguments);
}