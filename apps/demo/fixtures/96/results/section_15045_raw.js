async function* anon_15045() {
    ...
    getEnvironment(2)[1].whileTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[2].doWhileTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[3].forTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[4].forEachTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[6].nestedLoopTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[7].complexTest.call(undefined)
    ...
    getEnvironment(2)[8].ifElseChainTest.call(undefined, r5, r7)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[9].labeledBreakTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 9>
    // USED → r1 = getEnvironment(2)[9];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[9].labeledContinueTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 9>
    // USED → r1 = getEnvironment(2)[9];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[9].labeledBlockBreakTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 9>
    // USED → r1 = getEnvironment(2)[9];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[9].tripleNestedLabeledTest.call(undefined)
    ...
    getEnvironment(2)[10].ternaryTest.call(undefined, r1)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 10>
    // USED → r1 = getEnvironment(2)[10];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[10].shortCircuitAssignTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 10>
    // USED → r1 = getEnvironment(2)[10];
    ...
    // CODE → <Call3>: <Reg8: 1, Reg8: 1, Reg8: 2, Reg8: 5, Reg8: 7>
    getEnvironment(2)[10].logicalShortCircuitTest.call(undefined, r5, r7)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].tryCatchTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].tryCatchNoFinallyTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].tryFinallyNoCatchTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].tryFinallyNormalCompletionTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].tryCatchRethrowDifferentTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    getEnvironment(2)[11].tryLoopMultiReturnTest.call(undefined, r1)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].nestedTryCatchTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].nestedTryCatchFinallyTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[11].tryCatchFinallyEarlyReturnTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // USED → r1 = [1, 2, 0, 3];
    // CODE → <Call2>: <Reg8: 1, Reg8: 7, Reg8: 2, Reg8: 1>
    getEnvironment(2)[11].tryFinallyLoopBreakTest.call(undefined, r1)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    getEnvironment(2)[11].tryCatchInsideLoopTest.call(undefined, r1)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    getEnvironment(2)[11].tryCatchFinallyBranchInFinallyTest.call(undefined, r5)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // USED → r1 = (r1[3] = -1)[4] = 3;
    // CODE → <Call2>: <Reg8: 1, Reg8: 5, Reg8: 2, Reg8: 1>
    getEnvironment(2)[11].loopBreakCrossesTryBoundaryTest.call(undefined, r1)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = getEnvironment(2)[11];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[13].objectLiteralTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[14].propertyAccessTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 14>
    // USED → r1 = getEnvironment(2)[14];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[14].computedPropertyTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 14>
    // USED → r1 = getEnvironment(2)[14];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[14].optionalChainingTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[15].callDestructuringTests.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[16].arrayTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[17].spreadArrayTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 17>
    // USED → r1 = getEnvironment(2)[17];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[17].spreadObjectTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 17>
    // USED → r1 = getEnvironment(2)[17];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[17].spreadFunctionArgsTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[18].callMapSetTests.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[20].callRegExpTests.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[21].arrowFunctionTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[22].closureTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 22>
    // USED → r1 = getEnvironment(2)[22];
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[22].closureLoopTest.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[23].callDefaultParameterTests.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[24].callRestParameterTests.call(undefined)
    ...
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    getEnvironment(2)[25].callGeneratorTests.call(undefined)
    ...
    getEnvironment(2)[27].classTest.call(undefined)
    ...
    getEnvironment(2)[28].privateStaticTest.call(undefined)
