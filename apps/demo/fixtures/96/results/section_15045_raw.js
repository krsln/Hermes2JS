async function* anon_15045() {
    ...
    // USED → r1 = r4[1].whileTest;
    // CODE → <LoadConstUndefined>: <Reg8: 2>
    // USED → r2 = undefined;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[1].whileTest.call(undefined)
    ...
    // USED → r1 = r4[2].doWhileTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[2].doWhileTest.call(undefined)
    ...
    // USED → r1 = r4[3].forTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[3].forTest.call(undefined)
    ...
    // USED → r1 = r4[4].forEachTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[4].forEachTest.call(undefined)
    ...
    // USED → r1 = r4[6].nestedLoopTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[6].nestedLoopTest.call(undefined)
    ...
    // USED → r1 = r4[7].complexTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[7].complexTest.call(undefined)
    ...
    // USED → r1 = r4[9].labeledBreakTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[9].labeledBreakTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 9>
    // USED → r1 = r4[9];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 13, string_id: 10940>  # String: 'labeledContinueTest' (Identifier)
    // USED → r1 = r4[9].labeledContinueTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[9].labeledContinueTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 9>
    // USED → r1 = r4[9];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 14, string_id: 8658>  # String: 'labeledBlockBreakTest' (Identifier)
    // USED → r1 = r4[9].labeledBlockBreakTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[9].labeledBlockBreakTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 9>
    // USED → r1 = r4[9];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 15, string_id: 10646>  # String: 'tripleNestedLabeledTest' (Identifier)
    // USED → r1 = r4[9].tripleNestedLabeledTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[9].tripleNestedLabeledTest.call(undefined)
    ...
    // USED → r1 = (r1[3] = -1)[4] = 3;
    // CODE → <Call2>: <Reg8: 1, Reg8: 5, Reg8: 2, Reg8: 1>
    r1 = r4[11].loopBreakCrossesTryBoundaryTest.call(undefined, r1)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 11>
    // USED → r1 = r4[11];
    // CODE → <GetById>: <Reg8: 5, Reg8: 1, UInt8: 33, string_id: 8763>  # String: 'switchInsideTryTest' (Identifier)
    // USED → r5 = r4[11].switchInsideTryTest;
    // CODE → <LoadConstUInt8>: <Reg8: 1, UInt8: 1>
    // USED → r1 = 1;
    // CODE → <Call2>: <Reg8: 1, Reg8: 5, Reg8: 2, Reg8: 1>
    r1 = r4[11].switchInsideTryTest.call(undefined, 1)
    ...
    // USED → r1 = r4[12].forOfTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[12].forOfTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 12>
    // USED → r1 = r4[12];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 35, string_id: 11239>  # String: 'forInTest' (Identifier)
    // USED → r1 = r4[12].forInTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[12].forInTest.call(undefined)
    ...
    // USED → r1 = r4[13].objectLiteralTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[13].objectLiteralTest.call(undefined)
    ...
    // USED → r1 = r4[14].propertyAccessTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[14].propertyAccessTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 14>
    // USED → r1 = r4[14];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 38, string_id: 11290>  # String: 'computedPropertyTest' (Identifier)
    // USED → r1 = r4[14].computedPropertyTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[14].computedPropertyTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 14>
    // USED → r1 = r4[14];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 39, string_id: 11295>  # String: 'optionalChainingTest' (Identifier)
    // USED → r1 = r4[14].optionalChainingTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[14].optionalChainingTest.call(undefined)
    ...
    // USED → r1 = r4[15].callDestructuringTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[15].callDestructuringTests.call(undefined)
    ...
    // USED → r1 = r4[16].arrayTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[16].arrayTest.call(undefined)
    ...
    // USED → r1 = r4[17].spreadArrayTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[17].spreadArrayTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 17>
    // USED → r1 = r4[17];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 43, string_id: 10795>  # String: 'spreadObjectTest' (Identifier)
    // USED → r1 = r4[17].spreadObjectTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[17].spreadObjectTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 17>
    // USED → r1 = r4[17];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 44, string_id: 10792>  # String: 'spreadFunctionArgsTest' (Identifier)
    // USED → r1 = r4[17].spreadFunctionArgsTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[17].spreadFunctionArgsTest.call(undefined)
    ...
    // USED → r1 = r4[18].callMapSetTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[18].callMapSetTests.call(undefined)
    ...
    // USED → r7 = r4[19].basicTemplateTest;
    ...
    // USED → r1 = r4[20].callRegExpTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[20].callRegExpTests.call(undefined)
    ...
    // USED → r1 = r4[21].arrowFunctionTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[21].arrowFunctionTest.call(undefined)
    ...
    // USED → r1 = r4[22].closureTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[22].closureTest.call(undefined)
    // CODE → <LoadFromEnvironment>: <Reg8: 1, Reg8: 4, UInt8: 22>
    // USED → r1 = r4[22];
    // CODE → <GetById>: <Reg8: 1, Reg8: 1, UInt8: 52, string_id: 11176>  # String: 'closureLoopTest' (Identifier)
    // USED → r1 = r4[22].closureLoopTest;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[22].closureLoopTest.call(undefined)
    ...
    // USED → r1 = r4[23].callDefaultParameterTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[23].callDefaultParameterTests.call(undefined)
    ...
    // USED → r1 = r4[24].callRestParameterTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[24].callRestParameterTests.call(undefined)
    ...
    // USED → r1 = r4[25].callGeneratorTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    r1 = r4[25].callGeneratorTests.call(undefined)
    ...
    // USED → r1 = r4[26].callAsyncTests;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 2>
    // USED → r1 = await r4[26].callAsyncTests.call(undefined);
    // CODE → <SaveGenerator>: <Addr8: 4>  # Address: 000003ad
    goto label_941;
    // ──────────────── Block 2 ──────────────── 
    // CODE → <Ret>: <Reg8: 1>
    return await r4[26].callAsyncTests.call(undefined);
    // ──────────────── Block 3 ──────────────── 
    ...
    // USED → r5 = r4[27].classTest;
    // CODE → <Call1>: <Reg8: 5, Reg8: 5, Reg8: 2>
    r5 = r4[27].classTest.call(undefined)
    ...
    // USED → r4 = r4[28].privateStaticTest;
    // CODE → <Call1>: <Reg8: 4, Reg8: 4, Reg8: 2>
    r4 = r4[28].privateStaticTest.call(undefined)
