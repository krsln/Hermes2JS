function get(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4518>  # String: '__BC:Classes/ClassTests/Animal/get-description' (String)
    ...
    // USED → r3 = this.name;
    // CODE → <TryGetById>: <Reg8: 0, Reg8: 0, UInt8: 4, string_id: 15>  # String: 'HermesInternal' (Identifier)
    // USED → r0 = globalThis.HermesInternal;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 0, UInt8: 5, string_id: 97>  # String: 'concat' (Identifier)
    // USED → r2 = globalThis.HermesInternal.concat;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 6948>  # String: '' (Identifier)
    // USED → r1 = "";
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 1045>  # String: ' the animal' (String)
    // USED → r0 = " the animal";
