function function_15197(param0) {
    ...
    // USED → r3 = Animal(param0, param1, param2);
    // CODE → <StoreToEnvironment>: <Reg8: 4, UInt8: 0, Reg8: 3>
    createEnvironment()[0] = Animal(param0, param1, param2)
    ...
    // USED → r0 = getEnvironment(0)[4].default.call(undefined, Animal(param0, param1, param2), r1);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[4].default.call(undefined, Animal(param0, param1, param2), r1);
}