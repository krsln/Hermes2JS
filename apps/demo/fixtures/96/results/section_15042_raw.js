function runAllTests(param0) {
    ...
    // CODE → <LoadFromEnvironment>: <Reg8: 3, Reg8: 1, UInt8: 29>
    // USED → r3 = getEnvironment(0)[29];
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 65>  # String: 'apply' (Identifier)
    // USED → r2 = getEnvironment(0)[29].apply;
    ...
    // USED → r0 = getEnvironment(0)[29].apply(this, arguments);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[29].apply(this, arguments);
}