function nestedObjectDestructureTest(param0) {
    ...
    if ({ status: 200, body: { user: { "id": 1, "name": "Ada" }, meta: { page: 1 } } }.body.meta !== undefined) goto label_104;
    // ──────────────── Block 1 ──────────────── 
    // CODE → <NewObject>: <Reg8: 2>
    // USED → r2 = {  };
    // ──────────────── Block 2 ──────────────── 
    ...
    if ({  }.page === undefined) goto label_117;
    // ──────────────── Block 3 ──────────────── 
    ...
    r2 = globalThis.console.log({ status: 200, body: { user: { "id": 1, "name": "Ada" }, meta: { page: 1 } } }.status, { status: 200, body: { user: { "id": 1, "name": "Ada" }, meta: { page: 1 } } }.body.user.name, {  }.page)
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r3 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
