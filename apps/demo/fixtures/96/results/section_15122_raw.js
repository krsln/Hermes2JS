function function_15122(param0, param1, param2, param3, param4, param5, param6, param7) {
    ...
    createEnvironment()[3] = weakMapTest
    ...
    if (!param2.call(undefined, param7[0])) goto label_126;
    // ──────────────── Block 1 ──────────────── 
    ...
    // USED → r3 = { default: param2.call(undefined, param7[0]) };
    // CODE → <Mov>: <Reg8: 1, Reg8: 3>
    // USED → r1 = { default: param2.call(undefined, param7[0]) };
    // ──────────────── Block 3 ──────────────── 
    // CODE → <StoreToEnvironment>: <Reg8: 2, UInt8: 0, Reg8: 1>
    createEnvironment()[0] = { default: param2.call(undefined, param7[0]) }
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}