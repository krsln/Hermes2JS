function function_15158(param0, param1, param2, param3, param4, param5, param6, param7) {
    // ──────────────── Block 0 ──────────────── 
    ...
    // USED → r4 = restOnlyTest(param0);
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 0, Reg8: 4>
    createEnvironment()[0] = restOnlyTest(param0)
    ...
    // USED → r3 = restAfterRequiredTest(param0, param1, param2);
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 1, Reg8: 3>
    createEnvironment()[1] = restAfterRequiredTest(param0, param1, param2)
    ...
    // USED → r2 = legacyArgumentsTest(param0);
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 2, Reg8: 2>
    createEnvironment()[2] = legacyArgumentsTest(param0)
    ...
    // USED → r0 = callRestParameterTests(param0);
    // CODE → <PutById>: <Reg8: 1, Reg8: 0, UInt8: 4, string_id: 11222>  # String: 'callRestParameterTests' (Identifier)
    param6.callRestParameterTests = callRestParameterTests(param0)
