function nestedArrayDestructureTest(param0) {
    ...
    r0 = globalThis.console.log("__BC:Objects/DestructuringTests/nestedArrayDestructureTest/start")
    ...
    // USED → r5 = [[1, 2], [3, 4], [5, 6]][0];
    // CODE → <LoadConstUndefined>: <Reg8: 0>
    // USED → r0 = undefined;
    // CODE → <LoadConstUInt8>: <Reg8: 4, UInt8: 2>
    // USED → r4 = 2;
    // CODE → <Call3>: <Reg8: 5, Reg8: 7, Reg8: 0, Reg8: 5, Reg8: 4>
    // USED → r5 = getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][0], 2);
    // CODE → <GetByVal>: <Reg8: 10, Reg8: 5, Reg8: 6>
    // USED → r10 = getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][0], 2)[0];
    // CODE → <LoadConstUInt8>: <Reg8: 7, UInt8: 1>
    // USED → r7 = 1;
    // CODE → <GetByVal>: <Reg8: 9, Reg8: 5, Reg8: 7>
    // USED → r9 = getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][0], 2)[1];
    ...
    // USED → r3 = [[1, 2], [3, 4], [5, 6]][2];
    // CODE → <Call3>: <Reg8: 3, Reg8: 5, Reg8: 0, Reg8: 3, Reg8: 4>
    // USED → r3 = getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][2], 2);
    // CODE → <GetByVal>: <Reg8: 8, Reg8: 3, Reg8: 7>
    // USED → r8 = getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][2], 2)[1];
    ...
    r3 = globalThis.console.log(getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][0], 2)[0], getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][0], 2)[1], getEnvironment(0)[1].default.call(undefined, [[1, 2], [3, 4], [5, 6]][2], 2)[1])
    ...
    r5 = ([10][0] === undefined) ? 0 : [10][0]
    // ──────────────── Block 2 ──────────────── 
    // CODE → <GetByVal>: <Reg8: 7, Reg8: 3, Reg8: 7>
    // USED → r7 = [10][1];
    // CODE → <LoadConstZero>: <Reg8: 6>
    r6 = ([10][1] === undefined) ? 0 : [10][1]
    // ──────────────── Block 4 ──────────────── 
    ...
    // USED → r3 = getEnvironment(0)[0].default.call(undefined, [10]);
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 4, string_id: 227>  # String: 'slice' (Identifier)
    // USED → r2 = getEnvironment(0)[0].default.call(undefined, [10]).slice;
    // CODE → <Call2>: <Reg8: 4, Reg8: 2, Reg8: 3, Reg8: 4>
    // USED → r4 = getEnvironment(0)[0].default.call(undefined, [10]).slice(2);
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r3 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <Call4>: <Reg8: 2, Reg8: 2, Reg8: 3, Reg8: 5, Reg8: 6, Reg8: 4>
    r2 = globalThis.console.log(([10][0] === undefined) ? 0 : [10][0], ([10][1] === undefined) ? 0 : [10][1], getEnvironment(0)[0].default.call(undefined, [10]).slice(2))
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r3 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    ...
    r1 = globalThis.console.log("__BC:Objects/DestructuringTests/nestedArrayDestructureTest/end")
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}