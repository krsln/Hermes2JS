function privateStaticTest() {
    ...
    // USED → r2 = new r1[8]().increment;
    // CODE → <Call1>: <Reg8: 2, Reg8: 2, Reg8: 5>
    r2 = new r1[8]().increment()
    // CODE → <GetById>: <Reg8: 2, Reg8: 5, UInt8: 4, string_id: 10830>  # String: 'increment' (Identifier)
    // USED → r2 = new r1[8]().increment;
    // CODE → <Call1>: <Reg8: 2, Reg8: 2, Reg8: 5>
    r2 = new r1[8]().increment()
