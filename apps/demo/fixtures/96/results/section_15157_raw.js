function callDefaultParameterTests() {
    ...
    // USED → r2 = console.log;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4771>  # String: '__BC:Functions/DefaultParameterTests/callDefaultParameterTests/start' (String)
    ...
    r3 = getEnvironment(0)[0].call(undefined, r5)
    // CODE → <LoadConstUInt8>: <Reg8: 4, UInt8: 20>
    // USED → r4 = 20;
    // CODE → <Call3>: <Reg8: 3, Reg8: 6, Reg8: 0, Reg8: 5, Reg8: 4>
    r3 = getEnvironment(0)[0].call(undefined, r5, r4)
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 1248>  # String: 'sum' (String)
    // USED → r3 = "sum";
    // CODE → <Call4>: <Reg8: 3, Reg8: 6, Reg8: 0, Reg8: 5, Reg8: 4, Reg8: 3>
    r3 = getEnvironment(0)[0].call(undefined, r5, r4, "sum")
    ...
    r2 = getEnvironment(0)[1].call(undefined, r4, r3, r2)
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r3 = console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r2 = console.log;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4770>  # String: '__BC:Functions/DefaultParameterTests/callDefaultParameterTests/end' (String)
