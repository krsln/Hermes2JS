function parallelAwaitTest(param0) {
    ...
    // USED → r0 = getEnvironment(0)[10].apply(this, arguments);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[10].apply(this, arguments);
}