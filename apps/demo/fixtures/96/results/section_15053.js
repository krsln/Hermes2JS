function switchTest(param0, param1) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4572>  # String: '__BC:ControlFlow/SwitchTests/switchTest/start' (String)
    ...
    switch (param1) {
        case 0:
            ...
            // CODE → <LoadConstString>: <Reg8: 0, string_id: 2189>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-0' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 0, string_id: 618>  # String: 'zero' (String)
            // USED → r0 = "zero";
            // CODE → <Ret>: <Reg8: 0>
            return "zero";
        case 1:
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 360>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-1' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 7322>  # String: 'one' (Identifier)
            // USED → r1 = "one";
            // CODE → <Ret>: <Reg8: 1>
            return "one";
        case 2:
            ...
            // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
            // USED → r2 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 916>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-2' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 7510>  # String: 'two' (Identifier)
            // USED → r1 = "two";
            // CODE → <Ret>: <Reg8: 1>
            return "two";
        case 3:
            ...
            // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
            // USED → r2 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 1746>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-3-4' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 3705>  # String: 'three-four' (String)
            // USED → r1 = "three-four";
            // CODE → <Ret>: <Reg8: 1>
            return "three-four";
        default:
            ...
            // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
            // USED → r2 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 4569>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-default' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 1856>  # String: 'other' (String)
            // USED → r1 = "other";
            // CODE → <Ret>: <Reg8: 1>
            return "other";
    }
