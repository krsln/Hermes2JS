function defaultParameterTest(param0, param1) {
    ...
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 7145>  # String: 'result' (Identifier)
    // USED → r6 = "result";
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4597>  # String: '__BC:Functions/DefaultParameterTests/defaultParameterTest/start' (String)
