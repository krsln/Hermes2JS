function parameterDestructureTest(param0, param1, param2) {
    ...
    r6 = (param1.name === undefined) ? "anon" : param1.name
    ...
    r10 = getEnvironment(0)[1].default.call(undefined, param2, 2)[0]
    // CODE → <LoadConstUInt8>: <Reg8: 1, UInt8: 1>
    // USED → r1 = 1;
    // CODE → <GetByVal>: <Reg8: 9, Reg8: 2, Reg8: 1>
    r9 = getEnvironment(0)[1].default.call(undefined, param2, 2)[1]
    ...
    r2 = globalThis.console.log("__BC:Objects/DestructuringTests/parameterDestructureTest/start")
    ...
    r11 = (param1.name === undefined) ? "anon" : param1.name
    ...
    r1 = globalThis.console.log("__BC:Objects/DestructuringTests/parameterDestructureTest/end")
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}