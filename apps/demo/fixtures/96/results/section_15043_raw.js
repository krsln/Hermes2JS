function _runAllTests() {
    ...
    // USED → r3 = getEnvironment(0)[0].default.call(undefined, r2);
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 29, Reg8: 3>
    getEnvironment(0)[29] = getEnvironment(0)[0].default.call(undefined, r2)
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 65>  # String: 'apply' (Identifier)
    // USED → r2 = getEnvironment(0)[0].default.call(undefined, r2).apply;
    ...
    // USED → r0 = getEnvironment(0)[0].default.call(undefined, r2).apply(this, r1);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[0].default.call(undefined, r2).apply(this, r1);
}