function defaultParameterTest(param0, param1) {
    ...
    r5 = !(arguments.length > 1 && r3 !== r0) ? 10 : arguments[1]
    // ──────────────── Block 3 ──────────────── 
    // CODE → <GetArgumentsLength>: <Reg8: 3, Reg8: 2>
    // USED → r3 = arguments.length;
    ...
    r4 = !(arguments.length > 2 && r3 !== r0) ? "result" : arguments[2]
    // ──────────────── Block 6 ──────────────── 
    ...
    // USED → r1 = param1 + (!(arguments.length > 1 && r3 !== r0) ? 10 : arguments[1]);
    // CODE → <Call3>: <Reg8: 1, Reg8: 2, Reg8: 3, Reg8: 4, Reg8: 1>
    console.log(!(arguments.length > 2 && r3 !== r0) ? "result" : arguments[2], param1 + (!(arguments.length > 1 && r3 !== r0) ? 10 : arguments[1]))
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}