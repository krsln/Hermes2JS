function whileTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4577>  # String: '__BC:ControlFlow/WhileTests/whileTest/start' (String)
    ...
    // USED → r4 = 5;
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4576>  # String: '__BC:ControlFlow/WhileTests/whileTest/if-continue' (String)
    // USED → r3 = "__BC:ControlFlow/WhileTests/whileTest/if-continue";
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2368>  # String: 'while' (String)
    // USED → r2 = "while";
    ...
    while (0 === 2) {
        // ──────────────── Block 1 ──────────────── 
        // CODE → <TryGetById>: <Reg8: 7, Reg8: 0, UInt8: 1, string_id: 100>  # String: 'console' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4573>  # String: '__BC:ControlFlow/WhileTests/whileTest/end' (String)
