function callRegExpTests() {
    ...
    getEnvironment(0)[0].call(undefined, "abc123")
    ...
    // USED → r3 = "Hello\\nline two";
    // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 0, Reg8: 3>
    getEnvironment(0)[1].call(undefined, "Hello\\nline two")
    ...
    // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 0, Reg8: 3>
    getEnvironment(0)[2].call(undefined, "it's a test - really")
    ...
    getEnvironment(0)[3].call(undefined, "2024-01-15")
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r3 = console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r2 = console.log;
