function tryCatchTest(param0) {
    try {
        ...
        // CODE → <LoadConstString>: <Reg8: 0, string_id: 4099>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/start' (String)
        ...
        // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
        // USED → r2 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 0, string_id: 4582>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/try-block' (String)
        ...
        // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 3, string_id: 13>  # String: 'Error' (Identifier)
        // USED → r3 = globalThis.Error;
        // CODE → <GetByIdShort>: <Reg8: 0, Reg8: 3, UInt8: 4, string_id: 207>  # String: 'prototype' (Identifier)
        ...
        // CODE → <LoadConstString>: <Reg8: 5, string_id: 237>  # String: 'test' (Identifier)
        r5 = "test"
        ...
        // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 4, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
        // USED → r2 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 0, string_id: 4578>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/catch-block' (String)
        ...
        // CODE → <LoadConstString>: <Reg8: 2, string_id: 4580>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/finally-block' (String)
        ...
        // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
        // USED → r2 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 1, string_id: 10764>  # String: 'finally' (Identifier)
        // USED → r1 = "finally";
