function classTest() {
    ...
    // USED → r3 = new r1[5]("...", "Generic").makeSound;
    // CODE → <Call1>: <Reg8: 3, Reg8: 3, Reg8: 2>
    r3 = new r1[5]("...", "Generic").makeSound()
    ...
    // USED → r2 = new r1[5]("...", "Generic").description;
