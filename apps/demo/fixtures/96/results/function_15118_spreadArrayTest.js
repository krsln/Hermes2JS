function spreadArrayTest() {
    ...
    r7 = 0
    // CODE → addr: 44 | <CallBuiltin>: <Reg8: 7, UInt8: 46, UInt8: 4>  # Built-in function: [#46 HermesBuiltin_arraySpread]
    r7 = HermesBuiltin_arraySpread(r9, r8, r7, r6)
    // CODE → addr: 48 | <NewArrayWithBuffer>: <Reg8: 8, UInt16: 3, UInt16: 3, UInt16: 23671>  # Array: [4, 5, 6]
    r8 = [4, 5, 6]
    // CODE → addr: 56 | <Mov>: <Reg8: 9, Reg8: 3>
    r9 = r3
    // CODE → addr: 59 | <CallBuiltin>: <Reg8: 4, UInt8: 46, UInt8: 4>  # Built-in function: [#46 HermesBuiltin_arraySpread]
    r4 = HermesBuiltin_arraySpread(r9, r8, r7, r6)
    ...
    r7 = 1
    // CODE → addr: 99 | <CallBuiltin>: <Reg8: 2, UInt8: 46, UInt8: 4>  # Built-in function: [#46 HermesBuiltin_arraySpread]
    r2 = HermesBuiltin_arraySpread(r9, r8, r7, r6)
