function _parallelAwaitTest(param0) {
    // ──────────────── Block 0 ──────────────── 
    ...
    // USED → r3 = getEnvironment(0)[1].default.call(undefined, function_15188);
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 10, Reg8: 3>
    getEnvironment(0)[10] = getEnvironment(0)[1].default.call(undefined, function_15188)
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 2, string_id: 65>  # String: 'apply' (Identifier)
    // USED → r2 = getEnvironment(0)[1].default.call(undefined, function_15188).apply;
    ...
    // USED → r0 = getEnvironment(0)[1].default.call(undefined, function_15188).apply(this, arguments);
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(0)[1].default.call(undefined, function_15188).apply(this, arguments);
}