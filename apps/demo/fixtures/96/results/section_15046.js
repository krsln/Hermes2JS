function doWhileTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4535>  # String: '__BC:ControlFlow/DoWhileTests/doWhileTest/start' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4534>  # String: '__BC:ControlFlow/DoWhileTests/doWhileTest/end' (String)
