function legacyArgumentsTest(param0) {
    ...
    r2 = globalThis.console.log("__BC:Functions/RestParameterTests/legacyArgumentsTest/start")
    // CODE → <TryGetById>: <Reg8: 5, Reg8: 1, UInt8: 1, string_id: 99>  # String: 'console' (Identifier)
    // USED → r5 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 5, UInt8: 2, string_id: 90>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    ...
    r1 = globalThis.console.log("__BC:Functions/RestParameterTests/legacyArgumentsTest/end")
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}