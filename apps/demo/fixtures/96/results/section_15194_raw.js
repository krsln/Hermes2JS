function function_15194(param0, param1, param2, param3, param4, param5, param6, param7) {
    // ──────────────── Block 0 ──────────────── 
    ...
    // USED → r1 = function_15197(param0);
    // CODE → <Call1>: <Reg8: 3, Reg8: 1, Reg8: 0>
    // USED → r3 = function_15197(param0).call(undefined);
    // CODE → <StoreToEnvironment>: <Reg8: 2, UInt8: 5, Reg8: 3>
    createEnvironment()[5] = function_15197(param0).call(undefined)
    // CODE → <CreateClosure>: <Reg8: 1, Reg8: 2, function_id: 15201>  # Function: [#15201  of 106 bytes]: 2 params @ offset 0x0026b92e
    // USED → r1 = function_15201(param0, param1);
    // CODE → <Call2>: <Reg8: 1, Reg8: 1, Reg8: 0, Reg8: 3>
    // USED → r1 = function_15201(param0, param1).call(undefined, r3);
    // CODE → <StoreToEnvironment>: <Reg8: 2, UInt8: 6, Reg8: 1>
    createEnvironment()[6] = function_15201(param0, param1).call(undefined, r3)
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}