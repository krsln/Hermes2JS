function Counter() {
    ...
    getEnvironment(1)[2].default.call(undefined, this, r2)
    ...
    Object.defineProperty(this, r5, r4)
    // CODE → <TryGetById>: <Reg8: 7, Reg8: 1, UInt8: 2, string_id: 24>  # String: 'Object' (Identifier)
    // USED → r7 = Object;
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 7, UInt8: 3, string_id: 108>  # String: 'defineProperty' (Identifier)
    // USED → r6 = Object.defineProperty;
    ...
    // USED → r2 = getEnvironment(1)[4].default.call(undefined, r2, r3);
    // CODE → <GetByVal>: <Reg8: 1, Reg8: 2, Reg8: 3>
    r1 = getEnvironment(1)[4].default.call(undefined, r2, r3)[r3]
    // CODE → <Inc>: <Reg8: 1, Reg8: 1>
    // USED → r1 = r1 + 1;
    // CODE → <PutByVal>: <Reg8: 2, Reg8: 3, Reg8: 1>
    getEnvironment(1)[4].default.call(undefined, r2, r3)[getEnvironment(1)[6]] = r1 + 1
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}