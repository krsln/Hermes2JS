function function_15133(param0, param1, param2, param3, param4, param5, param6, param7) {
    // ──────────────── Block 0 ──────────────── 
    ...
    // USED → r5 = basicRegExpTest;
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 0, Reg8: 5>
    createEnvironment()[0] = basicRegExpTest
    ...
    // USED → r4 = regExpFlagsTest;
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 1, Reg8: 4>
    createEnvironment()[1] = regExpFlagsTest
    ...
    // USED → r3 = regExpSingleQuotePatternTest;
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 2, Reg8: 3>
    createEnvironment()[2] = regExpSingleQuotePatternTest
    ...
    // USED → r2 = regExpGroupsAndReplaceTest;
    // CODE → <StoreToEnvironment>: <Reg8: 0, UInt8: 3, Reg8: 2>
    createEnvironment()[3] = regExpGroupsAndReplaceTest
