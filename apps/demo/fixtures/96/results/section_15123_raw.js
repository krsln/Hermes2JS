function mapTest() {
    ...
    // USED → r4 = new globalThis.Map().set;
    ...
    // USED → r0 = new globalThis.Map().get;
    ...
    // USED → r6 = new globalThis.Map().has;
    ...
    // USED → r13 = getEnvironment(0)[0].default.call(undefined, r11, r7)[r6];
    // CODE → <GetByVal>: <Reg8: 12, Reg8: 10, Reg8: 3>
    // USED → r12 = getEnvironment(0)[0].default.call(undefined, r11, r7)[r3];
