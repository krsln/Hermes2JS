function function_15205(param1, param2, param3, param4, param5, param6, param7) {
    ...
    r0 = globalThis.Object.defineProperty(r1, "__esModule", r3)
    ...
    createEnvironment()[3] = _interopDefault(param0, param1).call(undefined, r1)
    ...
    createEnvironment()[4] = _interopDefault(param0, param1).call(undefined, r1)
    ...
    // USED → r3 = _interopDefault(param0, param1).call(undefined, r3);
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 3, UInt8: 3, string_id: 107>  # String: 'default' (Identifier)
    // USED → r6 = _interopDefault(param0, param1).call(undefined, r3).default;
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 7735>  # String: 'count' (Identifier)
    // USED → r4 = "count";
    // CODE → <Call2>: <Reg8: 4, Reg8: 6, Reg8: 0, Reg8: 4>
    // USED → r4 = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "count");
    // CODE → <StoreToEnvironment>: <Reg8: 5, UInt8: 5, Reg8: 4>
    createEnvironment()[5] = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "count")
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 3, UInt8: 3, string_id: 107>  # String: 'default' (Identifier)
    // USED → r6 = _interopDefault(param0, param1).call(undefined, r3).default;
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 1521>  # String: 'instances' (String)
    // USED → r4 = "instances";
    // CODE → <Call2>: <Reg8: 9, Reg8: 6, Reg8: 0, Reg8: 4>
    // USED → r9 = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "instances");
    // CODE → <StoreToEnvironment>: <Reg8: 5, UInt8: 6, Reg8: 9>
    createEnvironment()[6] = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "instances")
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 3, UInt8: 3, string_id: 107>  # String: 'default' (Identifier)
    // USED → r6 = _interopDefault(param0, param1).call(undefined, r3).default;
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 5021>  # String: 'privateHelper' (String)
    // USED → r4 = "privateHelper";
    // CODE → <Call2>: <Reg8: 4, Reg8: 6, Reg8: 0, Reg8: 4>
    // USED → r4 = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "privateHelper");
    // CODE → <StoreToEnvironment>: <Reg8: 5, UInt8: 7, Reg8: 4>
    createEnvironment()[7] = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "privateHelper")
    // CODE → <CreateClosure>: <Reg8: 4, Reg8: 5, function_id: 15209>  # Function: [#15209  of 166 bytes]: 1 params @ offset 0x0026bd80
    // USED → r4 = function_15209(param0);
    // CODE → <Call1>: <Reg8: 6, Reg8: 4, Reg8: 0>
    // USED → r6 = function_15209(param0).call(undefined);
    // CODE → <StoreToEnvironment>: <Reg8: 5, UInt8: 8, Reg8: 6>
    createEnvironment()[8] = function_15209(param0).call(undefined)
    ...
    r4 = globalThis.Object.defineProperty(r6, r9, r4)
    // CODE → <LoadConstUInt8>: <Reg8: 4, UInt8: 100>
    // USED → r4 = 100;
    // CODE → <PutById>: <Reg8: 6, Reg8: 4, UInt8: 2, string_id: 11547>  # String: 'MAX' (Identifier)
    function_15209(param0).call(undefined).MAX = 100
    // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 3, UInt8: 3, string_id: 107>  # String: 'default' (Identifier)
    // USED → r4 = _interopDefault(param0, param1).call(undefined, r3).default;
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 7671>  # String: 'label' (Identifier)
    // USED → r3 = "label";
    // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 0, Reg8: 3>
    // USED → r3 = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label");
    // CODE → <StoreToEnvironment>: <Reg8: 5, UInt8: 9, Reg8: 3>
    createEnvironment()[9] = _interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label")
    // CODE → <CreateClosure>: <Reg8: 4, Reg8: 5, function_id: 15217>  # Function: [#15217  of 81 bytes]: 2 params @ offset 0x0026c046
    // USED → r4 = function_15217(param0, param1);
    // CODE → <Call2>: <Reg8: 4, Reg8: 4, Reg8: 0, Reg8: 6>
    // USED → r4 = function_15217(param0, param1).call(undefined, r6);
    // CODE → <StoreToEnvironment>: <Reg8: 5, UInt8: 10, Reg8: 4>
    createEnvironment()[10] = function_15217(param0, param1).call(undefined, r6)
    ...
    r5 = globalThis.Object.defineProperty(r4, r3, r5)
    ...
    // USED → r2 = _interopDefault(param0, param1).call(undefined, r1).default;
    // CODE → <Call3>: <Reg8: 2, Reg8: 2, Reg8: 0, Reg8: 4, Reg8: 3>
    // USED → r2 = _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3);
    // CODE → <GetByIdShort>: <Reg8: 1, Reg8: 1, UInt8: 3, string_id: 107>  # String: 'default' (Identifier)
    // USED → r1 = _interopDefault(param0, param1).call(undefined, r1).default;
    // CODE → <Call3>: <Reg8: 1, Reg8: 1, Reg8: 0, Reg8: 4, Reg8: 3>
    // USED → r1 = _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3);
    // CODE → <GetByVal>: <Reg8: 4, Reg8: 1, Reg8: 3>
    // USED → r4 = _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3)[_interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label")];
    // CODE → <GetById>: <Reg8: 1, Reg8: 4, UInt8: 6, string_id: 10961>  # String: 'toUpperCase' (Identifier)
    // USED → r1 = _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3)[_interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label")].toUpperCase;
    // CODE → <Call1>: <Reg8: 1, Reg8: 1, Reg8: 4>
    // USED → r1 = _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3)[_interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label")].toUpperCase();
    // CODE → <PutByVal>: <Reg8: 2, Reg8: 3, Reg8: 1>
    _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3)[_interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label")] = _interopDefault(param0, param1).call(undefined, r1).default.call(undefined, r4, r3)[_interopDefault(param0, param1).call(undefined, r3).default.call(undefined, "label")].toUpperCase()
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}