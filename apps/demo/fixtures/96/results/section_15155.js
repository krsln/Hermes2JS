function defaultWithRestTest() {
    ...
    // USED → r2 = function_15156(param0, param1, param2);
    // CODE → <Call3>: <Reg8: 3, Reg8: 3, Reg8: 4, Reg8: 2, Reg8: 5>
    // USED → r3 = new globalThis.Array((arguments.length <= 1) ? 0 : arguments.length - 1).reduce(function_15156(param0, param1, param2), r5);
