function defaultWithRestTest() {
    ...
    // USED → r3 = new Array((arguments.length <= 1) ? 0 : arguments.length - 1).reduce;
    ...
    // USED → r3 = new Array((arguments.length <= 1) ? 0 : arguments.length - 1).reduce(function_15156(param1, param2), r5);
