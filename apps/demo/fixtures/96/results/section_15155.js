function defaultWithRestTest(param0) {
    ...
    if (arguments.length > 0) {
        ...
        // USED → r1 = arguments[0];
        // CODE → <Mov>: <Reg8: 5, Reg8: 6>
        r5 = (arguments[0] === undefined) ? 1 : arguments[0]
    }
    // ──────────────── Block 3 ──────────────── 
    ...
    // USED → r3 = new globalThis.Array((arguments.length <= 1) ? 0 : arguments.length - 1).reduce(function_15156, (arguments[0] === undefined) ? 1 : arguments[0]);
