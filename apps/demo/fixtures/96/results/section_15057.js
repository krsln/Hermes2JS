function complexTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4533>  # String: '__BC:ControlFlow/ComplexTests/complexTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 12, UInt16: 5, UInt16: 5, UInt16: 23488>  # Array: [1, 2, 3, 4, 5]
    // USED → r12 = [1, 2, 3, 4, 5];
    ...
    // CODE → <LoadConstString>: <Reg8: 10, string_id: 834>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-1' (String)
    // USED → r10 = "__BC:ControlFlow/ComplexTests/complexTest/case-1";
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 300>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-2-continue' (String)
    // USED → r9 = "__BC:ControlFlow/ComplexTests/complexTest/case-2-continue";
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 3737>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-3' (String)
    // USED → r8 = "__BC:ControlFlow/ComplexTests/complexTest/case-3";
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 9991>  # String: 'three' (Identifier)
    // USED → r7 = "three";
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 4528>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-default' (String)
    // USED → r6 = "__BC:ControlFlow/ComplexTests/complexTest/case-default";
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 1856>  # String: 'other' (String)
    // USED → r5 = "other";
    ...
    if (0 < [1, 2, 3, 4, 5].length) {
        ...
        while (true) {
            ...
            // ──────────────── Block 4 ──────────────── 
            // CODE → <TryGetById>: <Reg8: 14, Reg8: 0, UInt8: 1, string_id: 100>  # String: 'console' (Identifier)
            // USED → r14 = globalThis.console;
            // CODE → <GetByIdShort>: <Reg8: 13, Reg8: 14, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4531>  # String: '__BC:ControlFlow/ComplexTests/complexTest/end' (String)
