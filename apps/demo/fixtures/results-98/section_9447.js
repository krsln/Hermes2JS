function forOfTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4767>  # String: '__BC:Iterators/IteratorTests/forOfTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 2, UInt16: 4, UInt16: 4, UInt16: 37010>  # Array: [1, 2, 3, 4]
    // USED → r2 = [1, 2, 3, 4];
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4766>  # String: '__BC:Iterators/IteratorTests/forOfTest/end' (String)
