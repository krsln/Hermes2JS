function classTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 1522>  # String: '__BC:Classes/ClassTests/classTest/start' (String)
    ...
    if (typeof getParentEnvironment(0)[0] !== "<128>") {
        // ──────────────── Block 1 ──────────────── 
        // CODE → <LoadConstString>: <Reg8: 8, string_id: 4280>  # String: 'Trying to call a non-function' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 2556>  # String: '__BC:Classes/ClassTests/Animal/constructor' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 3331>  # String: 'Generic' (String)
    // USED → r4 = "Generic";
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 737>  # String: '...' (String)
    // USED → r4 = "...";
    // CODE → <PutByIdStrict>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 11493>  # String: 'sound' (Identifier)
    Object.create(getParentEnvironment(0)[0].prototype).sound = "..."
    // CODE → <GetById>: <Reg8: 4, Reg8: 3, UInt8: 3, string_id: 10392>  # String: 'makeSound' (Identifier)
    ...
    // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r4 = globalThis.console.log;
    // CODE → <GetById>: <Reg8: 3, Reg8: 3, UInt8: 4, string_id: 10999>  # String: 'description' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 4402>  # String: 'Woof' (String)
    r7 = "Woof"
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 3574>  # String: 'Rex' (String)
    r8 = "Rex"
    ...
    // CODE → <GetByIdShort>: <Reg8: 5, Reg8: 6, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r5 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2250>  # String: '__BC:Classes/ClassTests/Dog/constructor' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2358>  # String: 'Labrador' (String)
    // USED → r2 = "Labrador";
    // CODE → <PutByIdStrict>: <Reg8: 3, Reg8: 2, UInt8: 2, string_id: 15980>  # String: 'breed' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 2, Reg8: 3, UInt8: 3, string_id: 10392>  # String: 'makeSound' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2732>  # String: 'Buddy' (String)
    // USED → r2 = "Buddy";
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4696>  # String: '__BC:Classes/ClassTests/classTest/end' (String)
