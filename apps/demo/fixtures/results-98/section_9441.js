function switchTest(param0, param1) {
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4736>  # String: '__BC:ControlFlow/SwitchTests/switchTest/start' (String)
    ...
    switch (param1) {
        case 0:
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 4732>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-0' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 1, string_id: 588>  # String: 'zero' (String)
            // USED → r1 = "zero";
            // CODE → <Ret>: <Reg8: 1>
            return "zero";
        case 1:
            ...
            // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r3 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 2010>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-1' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 6723>  # String: 'one' (Identifier)
            // USED → r2 = "one";
            // CODE → <Ret>: <Reg8: 2>
            return "one";
        case 2:
            ...
            // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r3 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 902>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-2' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 9030>  # String: 'two' (Identifier)
            // USED → r2 = "two";
            // CODE → <Ret>: <Reg8: 2>
            return "two";
        case 3:
            ...
            // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r3 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 1724>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-3-4' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 3941>  # String: 'three-four' (String)
            // USED → r2 = "three-four";
            // CODE → <Ret>: <Reg8: 2>
            return "three-four";
        default:
            ...
            // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r3 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 4733>  # String: '__BC:ControlFlow/SwitchTests/switchTest/case-default' (String)
            ...
            // CODE → <LoadConstString>: <Reg8: 2, string_id: 1849>  # String: 'other' (String)
            // USED → r2 = "other";
            // CODE → <Ret>: <Reg8: 2>
            return "other";
    }
