function forEachTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4708>  # String: '__BC:ControlFlow/ForEachTests/forEachTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 4, UInt16: 4, UInt16: 4, UInt16: 48413>  # Array: [10, 20, 30, 40]
    // USED → r4 = [10, 20, 30, 40];
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 2, string_id: 147>  # String: 'forEach' (Identifier)
    // USED → r3 = [10, 20, 30, 40].forEach;
    // CODE → <LoadConstUndefined>: <Reg8: 0>
    // USED → r0 = undefined;
    // CODE → <CreateClosure>: <Reg8: 2, Reg8: 0, function_id: 12394>  # Function: [#12394  of 78 bytes]: 3 params @ offset 0x0023e317
    // USED → r2 = function_12394;
    // CODE → <Call2>: <Reg8: 2, Reg8: 3, Reg8: 4, Reg8: 2>
    r2 = [10, 20, 30, 40].forEach(function_12394)
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4703>  # String: '__BC:ControlFlow/ForEachTests/forEachTest/end' (String)
