function tryCatchTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4750>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/start' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4751>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/try-block' (String)
    ...
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4744>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/catch-block' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4748>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/finally-block' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 11086>  # String: 'finally' (Identifier)
    // USED → r0 = "finally";
    // CODE → <Call2>: <Reg8: 0, Reg8: 2, Reg8: 3, Reg8: 0>
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4746>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/end' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4748>  # String: '__BC:Exceptions/ExceptionTests/tryCatchTest/finally-block' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 11086>  # String: 'finally' (Identifier)
    // USED → r1 = "finally";
