function computedPropertyTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4774>  # String: '__BC:Objects/PropertyTests/computedPropertyTest/start' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    // CODE → <NewObjectWithBuffer>: <Reg8: 2, UInt16: 1915, UInt16: 46706>  # Object: {'dynamic': 42, 'staticKey': 'value'}
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4771>  # String: '__BC:Objects/PropertyTests/computedPropertyTest/end' (String)
