function spreadArrayTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4688>  # String: '__BC:Arrays/SpreadTests/spreadArrayTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 3, UInt16: 3, UInt16: 3, UInt16: 19180>  # Array: [1, 2, 3]
    // USED → r3 = [1, 2, 3];
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 12, UInt16: 3, UInt16: 3, UInt16: 11358>  # Array: [4, 5, 6]
    r12 = [4, 5, 6]
    // CODE → <Mov>: <Reg8: 13, Reg8: 0>
    r13 = []
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 5, UInt16: 2, UInt16: 1, UInt16: 17259>  # Array: [0]
    // USED → r5 = [0];
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4687>  # String: '__BC:Arrays/SpreadTests/spreadArrayTest/end' (String)
