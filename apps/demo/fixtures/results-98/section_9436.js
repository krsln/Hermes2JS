function runAllTests(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 4780>  # String: '__BC:index/runAllTests/start' (String)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 2, string_id: 11070>  # String: 'whileTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 3, string_id: 11011>  # String: 'doWhileTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 4, string_id: 11023>  # String: 'forTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 5, string_id: 11014>  # String: 'forEachTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 6, string_id: 11061>  # String: 'switchTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 7, string_id: 8450>  # String: 'nestedLoopTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 8, string_id: 7767>  # String: 'complexTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 9, string_id: 9390>  # String: 'ifTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 10, string_id: 11034>  # String: 'ifElseChainTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 11, string_id: 11080>  # String: 'tryCatchTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 12, string_id: 11109>  # String: 'forOfTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 13, string_id: 11106>  # String: 'forInTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 14, string_id: 11114>  # String: 'objectLiteralTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 15, string_id: 11136>  # String: 'propertyAccessTest' (Identifier)
    // USED → r7 = getParentEnvironment(0)[11].propertyAccessTest;
    // CODE → <Call1>: <Reg8: 7, Reg8: 7, Reg8: 1>
    r7 = getParentEnvironment(0)[11].propertyAccessTest.call(undefined)
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 16, string_id: 11119>  # String: 'computedPropertyTest' (Identifier)
    // USED → r7 = getParentEnvironment(0)[11].computedPropertyTest;
    // CODE → <Call1>: <Reg8: 7, Reg8: 7, Reg8: 1>
    r7 = getParentEnvironment(0)[11].computedPropertyTest.call(undefined)
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 17, string_id: 11131>  # String: 'optionalChainingTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 18, string_id: 10970>  # String: 'arrayTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 19, string_id: 10980>  # String: 'spreadArrayTest' (Identifier)
    // USED → r7 = getParentEnvironment(0)[13].spreadArrayTest;
    // CODE → <Call1>: <Reg8: 7, Reg8: 7, Reg8: 1>
    r7 = getParentEnvironment(0)[13].spreadArrayTest.call(undefined)
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 20, string_id: 10993>  # String: 'spreadObjectTest' (Identifier)
    // USED → r7 = getParentEnvironment(0)[13].spreadObjectTest;
    // CODE → <Call1>: <Reg8: 7, Reg8: 7, Reg8: 1>
    r7 = getParentEnvironment(0)[13].spreadObjectTest.call(undefined)
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 21, string_id: 10986>  # String: 'spreadFunctionArgsTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 22, string_id: 7936>  # String: 'arrowFunctionTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 7, Reg8: 6, UInt8: 23, string_id: 8911>  # String: 'closureTest' (Identifier)
    // USED → r7 = getParentEnvironment(0)[15].closureTest;
    // CODE → <Call1>: <Reg8: 7, Reg8: 7, Reg8: 1>
    r7 = getParentEnvironment(0)[15].closureTest.call(undefined)
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 24, string_id: 11096>  # String: 'closureLoopTest' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 6, Reg8: 6, UInt8: 25, string_id: 8334>  # String: 'callDefaultParameterTests' (Identifier)
    ...
    // CODE → <GetById>: <Reg8: 5, Reg8: 5, UInt8: 26, string_id: 11007>  # String: 'classTest' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 3441>  # String: '__BC:index/runAllTests/end' (String)
