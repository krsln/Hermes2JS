function optionalChainingTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 4776>  # String: '__BC:Objects/PropertyTests/optionalChainingTest/start' (String)
    ...
    if ({ "b": null } != null) {
        ...
        if ({ "b": null }.b != null) {
            // ──────────────── Block 2 ──────────────── 
            // CODE → <GetById>: <Reg8: 7, Reg8: 5, UInt8: 3, string_id: 6349>  # String: 'c' (Identifier)
            // USED → r7 = { "b": null }.b.c;
        }
    }
    if ({ "b": null }.b.c == null) {
    ...
    // CODE → <GetByIdShort>: <Reg8: 5, Reg8: 6, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r5 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 4775>  # String: '__BC:Objects/PropertyTests/optionalChainingTest/end' (String)
