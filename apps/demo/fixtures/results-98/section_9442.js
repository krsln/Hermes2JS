function nestedLoopTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 11, string_id: 4731>  # String: '__BC:ControlFlow/NestedTests/nestedLoopTest/start' (String)
    ...
    // USED → r7 = 4;
    // CODE → <LoadConstString>: <Reg8: 12, string_id: 2584>  # String: '__BC:ControlFlow/NestedTests/nestedLoopTest/deep-if' (String)
    // USED → r12 = "__BC:ControlFlow/NestedTests/nestedLoopTest/deep-if";
    // CODE → <LoadConstString>: <Reg8: 11, string_id: 1480>  # String: 'nested' (String)
    // USED → r11 = "nested";
    ...
    // CODE → <LoadConstString>: <Reg8: 10, string_id: 4262>  # String: '__BC:ControlFlow/NestedTests/nestedLoopTest/end' (String)
