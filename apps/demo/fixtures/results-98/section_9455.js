function spreadObjectTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4692>  # String: '__BC:Arrays/SpreadTests/spreadObjectTest/start' (String)
    ...
    // USED → r5 = {  };
    // CODE → <NewObjectWithBuffer>: <Reg8: 8, UInt16: 61, UInt16: 42589>  # Object: {'x': 1, 'y': 2}
    r8 = { "x": 1, "y": 2 }
    ...
    // USED → r0 = 3;
    // CODE → <DefineOwnById>: <Reg8: 5, Reg8: 0, UInt8: 0, UInt16: 6497>
    {  }.string_6497 = 3
    ...
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 5, UInt8: 2, string_id: 28>  # String: 'x' (Identifier)
    // USED → r6 = {  }.x;
    // CODE → <NewObject>: <Reg8: 9>
    r9 = {  }
    // CODE → <LoadConstNull>: <Reg8: 1>
    // USED → r1 = null;
    // CODE → <NewObjectWithBufferAndParent>: <Reg8: 7, Reg8: 1, UInt32: 1118, UInt32: 17259>
    r7 = {  }
    // CODE → <Mov>: <Reg8: 8, Reg8: 5>
    r8 = {  }
    // CODE → <CallBuiltin>: <Reg8: 5, UInt8: 46, UInt8: 4>  # Built-in function: [#46 arraySpread]
    // USED → r5 = builtin_46(r1, r2, r3, r4);
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 2, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    // CODE → <Call3>: <Reg8: 3, Reg8: 3, Reg8: 4, Reg8: 6, Reg8: 5>
    r3 = globalThis.console.log({  }.x, builtin_46(r1, r2, r3, r4))
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 2, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4691>  # String: '__BC:Arrays/SpreadTests/spreadObjectTest/end' (String)
