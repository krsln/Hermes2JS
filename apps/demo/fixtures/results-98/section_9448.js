function forInTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 4765>  # String: '__BC:Iterators/IteratorTests/forInTest/start' (String)
    ...
    // CODE → <NewObjectWithBuffer>: <Reg8: 7, UInt16: 1912, UInt16: 19180>  # Object: {'a': 1, 'b': 2, 'c': 3}
    // USED → r7 = { "a": 1, "b": 2, "c": 3 };
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4762>  # String: '__BC:Iterators/IteratorTests/forInTest/end' (String)
