function whileTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 4743>  # String: '__BC:ControlFlow/WhileTests/whileTest/start' (String)
    ...
    // USED → r4 = 5;
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 4741>  # String: '__BC:ControlFlow/WhileTests/whileTest/if-continue' (String)
    // USED → r9 = "__BC:ControlFlow/WhileTests/whileTest/if-continue";
    // CODE → <LoadConstUInt8>: <Reg8: 3, UInt8: 1>
    // USED → r3 = 1;
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 2457>  # String: 'while' (String)
    // USED → r8 = "while";
    ...
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 4739>  # String: '__BC:ControlFlow/WhileTests/whileTest/end' (String)
