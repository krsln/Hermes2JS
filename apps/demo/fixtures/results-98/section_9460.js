function defaultParameterTest(param0, param1) {
    ...
    if (param3 === undefined) {
        // ──────────────── Block 3 ──────────────── 
        // CODE → <LoadConstString>: <Reg8: 5, string_id: 7712>  # String: 'result' (Identifier)
        // USED → r5 = "result";
    }
    // ──────────────── Block 4 ──────────────── 
    ...
    // USED → r3 = globalThis;
    // CODE → <TryGetById>: <Reg8: 8, Reg8: 3, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 4760>  # String: '__BC:Functions/DefaultParameterTests/defaultParameterTest/start' (String)
    ...
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 3, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
