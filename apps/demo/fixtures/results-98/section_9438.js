function doWhileTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 4702>  # String: '__BC:ControlFlow/DoWhileTests/doWhileTest/start' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 7, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r6 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 4701>  # String: '__BC:ControlFlow/DoWhileTests/doWhileTest/end' (String)
