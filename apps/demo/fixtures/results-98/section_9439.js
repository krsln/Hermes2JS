function forTest(param0) {
    ...
    // USED → r7 = globalThis;
    // CODE → <TryGetById>: <Reg8: 10, Reg8: 7, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 4716>  # String: '__BC:ControlFlow/ForTests/forTest/start' (String)
    ...
    // USED → r3 = 10;
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 4715>  # String: '__BC:ControlFlow/ForTests/forTest/if-continue' (String)
    ...
    while (0 === 3) {
        ...
        if (0 + 1 < 10) goto label_40;
    }
    // LOOP → END
    // ──────────────── Block 4 ──────────────── 
    // CODE → <TryGetById>: <Reg8: 11, Reg8: 7, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r11 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 10, Reg8: 11, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r10 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 4714>  # String: '__BC:ControlFlow/ForTests/forTest/if-break' (String)
    ...
    goto label_115;
    // ──────────────── Block 7 ──────────────── 
    // CODE → <TryGetById>: <Reg8: 9, Reg8: 7, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 4709>  # String: '__BC:ControlFlow/ForTests/forTest/end' (String)
