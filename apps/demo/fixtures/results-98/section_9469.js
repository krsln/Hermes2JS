function create(param0, param1) {
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 538>  # String: '__BC:Classes/ClassTests/Dog/static-create' (String)
    ...
    if (typeof getParentEnvironment(0)[2] !== "<128>") {
        // ──────────────── Block 1 ──────────────── 
        // CODE → <LoadConstString>: <Reg8: 7, string_id: 4280>  # String: 'Trying to call a non-function' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 4402>  # String: 'Woof' (String)
    r6 = "Woof"
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 2250>  # String: '__BC:Classes/ClassTests/Dog/constructor' (String)
    // USED → r1 = "__BC:Classes/ClassTests/Dog/constructor";
    // CODE → <Call2>: <Reg8: 1, Reg8: 2, Reg8: 3, Reg8: 1>
    r1 = globalThis.console.log("__BC:Classes/ClassTests/Dog/constructor")
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 3650>  # String: 'Mixed' (String)
    // USED → r1 = "Mixed";
    // CODE → <PutByIdStrict>: <Reg8: 0, Reg8: 1, UInt8: 0, string_id: 15980>  # String: 'breed' (Identifier)
