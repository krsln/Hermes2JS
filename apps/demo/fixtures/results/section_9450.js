function propertyAccessTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4779>  # String: '__BC:Objects/PropertyTests/propertyAccessTest/start' (String)
    ...
    // CODE → <NewObjectWithBuffer>: <Reg8: 4, UInt16: 61, UInt16: 42589>  # Object: {'x': 1, 'y': 2}
    // USED → r4 = { "x": 1, "y": 2 };
    // CODE → <LoadConstUInt8>: <Reg8: 0, UInt8: 3>
    // USED → r0 = 3;
    // CODE → <PutByIdStrict>: <Reg8: 4, Reg8: 0, UInt8: 0, string_id: 6497>  # String: 'z' (Identifier)
    { "x": 1, "y": 2 }.z = 3
    ...
    // USED → r2 = { "x": 1, "y": 2 }.y;
    // CODE → <GetById>: <Reg8: 0, Reg8: 4, UInt8: 4, string_id: 6497>  # String: 'z' (Identifier)
    // USED → r0 = { "x": 1, "y": 2 }.z;
    ...
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4777>  # String: '__BC:Objects/PropertyTests/propertyAccessTest/end' (String)
