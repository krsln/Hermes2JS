function complexTest(param0) {
    ...
    // USED → r6 = globalThis;
    // CODE → <TryGetById>: <Reg8: 9, Reg8: 6, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r9 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 8, Reg8: 9, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r8 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 4700>  # String: '__BC:ControlFlow/ComplexTests/complexTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 14, UInt16: 5, UInt16: 5, UInt16: 4451>  # Array: [1, 2, 3, 4, 5]
    // USED → r14 = [1, 2, 3, 4, 5];
    // CODE → <GetByIdShort>: <Reg8: 7, Reg8: 14, UInt8: 2, string_id: 176>  # String: 'length' (Identifier)
    // USED → r7 = [1, 2, 3, 4, 5].length;
    // CODE → <LoadConstZero>: <Reg8: 0>
    // USED → r0 = 0;
    // CODE → <Less>: <Reg8: 5, Reg8: 0, Reg8: 7>
    // USED → r5 = 0 < [1, 2, 3, 4, 5].length;
    // CODE → <LoadConstUInt8>: <Reg8: 2, UInt8: 1>
    // USED → r2 = 1;
    // CODE → <LoadConstString>: <Reg8: 13, string_id: 1712>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-1' (String)
    // USED → r13 = "__BC:ControlFlow/ComplexTests/complexTest/case-1";
    // CODE → <LoadConstString>: <Reg8: 12, string_id: 760>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-2-continue' (String)
    // USED → r12 = "__BC:ControlFlow/ComplexTests/complexTest/case-2-continue";
    // CODE → <LoadConstString>: <Reg8: 11, string_id: 2110>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-3' (String)
    // USED → r11 = "__BC:ControlFlow/ComplexTests/complexTest/case-3";
    // CODE → <LoadConstString>: <Reg8: 10, string_id: 10211>  # String: 'three' (Identifier)
    // USED → r10 = "three";
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 4697>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-default' (String)
    // USED → r9 = "__BC:ControlFlow/ComplexTests/complexTest/case-default";
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 1849>  # String: 'other' (String)
    // USED → r8 = "other";
    ...
    if (0 < [1, 2, 3, 4, 5].length) {
        ...
        while (true) {
            ...
            // ──────────────── Block 4 ──────────────── 
            // CODE → <TryGetById>: <Reg8: 15, Reg8: 6, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
            // USED → r15 = globalThis.console;
            // CODE → <GetByIdShort>: <Reg8: 7, Reg8: 15, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    ...
    // ──────────────── Block 9 ──────────────── 
    // CODE → <TryGetById>: <Reg8: 8, Reg8: 6, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r8 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 7, Reg8: 8, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r7 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 1856>  # String: '__BC:ControlFlow/ComplexTests/complexTest/end' (String)
