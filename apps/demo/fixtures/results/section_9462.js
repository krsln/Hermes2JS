function callDefaultParameterTests(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 4759>  # String: '__BC:Functions/DefaultParameterTests/callDefaultParameterTests/start' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 4760>  # String: '__BC:Functions/DefaultParameterTests/defaultParameterTest/start' (String)
    ...
    // USED → r0 = 15;
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 7712>  # String: 'result' (Identifier)
    // USED → r9 = "result";
    ...
    // CODE → <GetByIdShort>: <Reg8: 7, Reg8: 8, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r7 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 1399>  # String: 'sum' (String)
    // USED → r6 = "sum";
    ...
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 7, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r6 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 2458>  # String: '__BC:Functions/DefaultParameterTests/callDefaultParameterTests/end' (String)
