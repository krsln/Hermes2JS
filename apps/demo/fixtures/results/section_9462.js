function defaultParameterTest(param0, param1) {
    ...
    if (param3 === undefined) {
        // ──────────────── Block 3 ──────────────── 
        // CODE → <LoadConstString>: <Reg8: 5, string_id: 7699>  # String: 'result' (Identifier)
        // USED → r5 = "result";
    }
    // ──────────────── Block 4 ──────────────── 
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 4764>  # String: '__BC:Functions/DefaultParameterTests/defaultParameterTest/start' (String)
