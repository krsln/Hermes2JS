async function* anon_9594(param0, param1) {
    ...
    // USED → r1 = r2.HermesInternal.concat("https://coachify.ai/api/checkUsernameAvailable?username=", param1);
    // CODE → <Call2>: <Reg8: 1, Reg8: 3, Reg8: 4, Reg8: 1>
    r1 = await CallExpression(callee=MemberExpression(receiver=MemberExpression(receiver=MemberExpression(receiver=CallExpression(callee=Identifier(name='getEnvironment'), arguments=(NumericLiteral(value=4),), optional=False), member=NumericLiteral(value=16), computed=True, optional=False), member=Identifier(name='default'), computed=False, optional=False), member=Identifier(name='get'), computed=False, optional=False), arguments=(MemberExpression(receiver=MemberExpression(receiver=CallExpression(callee=Identifier(name='getEnvironment'), arguments=(NumericLiteral(value=4),), optional=False), member=NumericLiteral(value=16), computed=True, optional=False), member=Identifier(name='default'), computed=False, optional=False), CallExpression(callee=MemberExpression(receiver=MemberExpression(receiver=Identifier(name='r2'), member=Identifier(name='HermesInternal'), computed=False, optional=False), member=Identifier(name='concat'), computed=False, optional=False), arguments=(StringLiteral(value='https://coachify.ai/api/checkUsernameAvailable?username='), Identifier(name='param1')), optional=False)), optional=False)
    // CODE → <SaveGenerator>: <Addr8: 4>  # Address: 0000003a
    goto label_58;
    // LOOP → START (while)
    while (getEnvironment(4)[16].default.get) {
        // ──────────────── Block 3 ──────────────── 
