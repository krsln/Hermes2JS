async function* anon_9594(param0, param1) {
    ...
    // USED → r1 = r6("https://coachify.ai/api/checkUsernameAvailable?username=", r1);
    // CODE → <Call2>: <Reg8: 1, Reg8: 3, Reg8: 4, Reg8: 1>
    r1 = await CallExpression(callee=Identifier(name='r3'), arguments=(Identifier(name='r4'), CallExpression(callee=Identifier(name='r6'), arguments=(StringLiteral(value='https://coachify.ai/api/checkUsernameAvailable?username='), Identifier(name='r1')), optional=False)), optional=False)
