function AcquisitionManager(param0, param1, param2) {
    ...
    // USED → r2 = function_25631 /* Closure with env r2 = createEnvironment() */
    // CODE → <PutById>: <Reg8: 1, Reg8: 2, UInt8: 3, string_id: 24002>  # String: 'isRecoverable' (Identifier)
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */ }
    // CODE → <LoadParam>: <Reg8: 2, UInt8: 1>
    // USED → r2 = param1
    // CODE → <PutById>: <Reg8: 1, Reg8: 2, UInt8: 4, string_id: 20572>  # String: '_httpRequester' (Identifier)
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1 }
    ...
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1, _serverUrl: r0.serverUrl }
    ...
    // USED → r2 = r1._serverUrl + "/"
    // CODE → <PutById>: <Reg8: 1, Reg8: 2, UInt8: 5, string_id: 22212>  # String: '_serverUrl' (Identifier)
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1, _serverUrl: r1._serverUrl + "/" }
    // ──────────────── Block 2 ──────────────── 
    ...
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1, _serverUrl: r1._serverUrl + "/", _appVersion: r0.appVersion }
    ...
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1, _serverUrl: r1._serverUrl + "/", _appVersion: r0.appVersion, _clientUniqueId: r0.clientUniqueId }
    ...
    // USED → r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1, _serverUrl: r1._serverUrl + "/", _appVersion: r0.appVersion, _clientUniqueId: r0.clientUniqueId, _deploymentKey: r0.deploymentKey }
    ...
    r1 = { BASE_URL_PART: "appcenter.ms", _publicPrefixUrl: "v0.1/public/codepush/", isRecoverable: function_25631 /* Closure with env r2 = createEnvironment() */, _httpRequester: param1, _serverUrl: r1._serverUrl + "/", _appVersion: r0.appVersion, _clientUniqueId: r0.clientUniqueId, _deploymentKey: r0.deploymentKey, _ignoreAppVersion: r0.ignoreAppVersion }
