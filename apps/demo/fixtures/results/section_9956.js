async function* anon_9956(param0, param1) {
    ...
    // USED → r1 = await getEnvironment(3)[16].default.get("https://api.edamam.com/api/food-database/v2/parser?app_id=3ac995c0&app_key=86e23e190bd9559f728aeb1010a73765&nutrition-type=logging&ingr=" + r1)
    // CODE → <SaveGenerator>: <Addr8: 4>  # Address: 0000002c
    yield label_44;  // SaveGenerator: suspend and jump to 44
    // ──────────────── Block 2 ──────────────── 
    // CODE → <Ret>: <Reg8: 1>
    return await getEnvironment(3)[16].default.get("https://api.edamam.com/api/food-database/v2/parser?app_id=3ac995c0&app_key=86e23e190bd9559f728aeb1010a73765&nutrition-type=logging&ingr=" + r1);
    // ──────────────── Block 3 ──────────────── 
