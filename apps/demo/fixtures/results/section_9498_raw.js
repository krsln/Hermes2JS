function callMapSetTests(param0) {
    ...
    // USED → r4 = __uninitialized_this_for_new__r3;
    // CODE → <Mov>: <Reg8: 10, Reg8: 4>
    // USED → r10 = __uninitialized_this_for_new__r3;
    // CODE → <Construct>: <Reg8: 3, Reg8: 3, UInt8: 1>
    // USED → r3 = new globalThis.WeakMap(__uninitialized_this_for_new__r3);
    // CODE → <SelectObject>: <Reg8: 7, Reg8: 4, Reg8: 3>
    // USED → r7 = new globalThis.WeakMap(__uninitialized_this_for_new__r3);
    // CODE → <NewObject>: <Reg8: 6>
    // USED → r6 = {  };
    // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 7, UInt8: 4, string_id: 55>  # String: 'set' (Identifier)
    // USED → r4 = new globalThis.WeakMap(__uninitialized_this_for_new__r3).set;
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 211>  # String: 'value' (Identifier)
    // USED → r3 = "value";
    // CODE → <Call3>: <Reg8: 3, Reg8: 4, Reg8: 7, Reg8: 6, Reg8: 3>
    r3 = new globalThis.WeakMap(__uninitialized_this_for_new__r3).set(r6, "value")
    // CODE → <TryGetById>: <Reg8: 5, Reg8: 2, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r5 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
    // USED → r4 = globalThis.console.log;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 7, UInt8: 5, string_id: 11>  # String: 'has' (Identifier)
    // USED → r3 = new globalThis.WeakMap(__uninitialized_this_for_new__r3).has;
    // CODE → <Call2>: <Reg8: 3, Reg8: 3, Reg8: 7, Reg8: 6>
    // USED → r3 = new globalThis.WeakMap(__uninitialized_this_for_new__r3).has(r6);
    // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
    console.log(r3)
    // CODE → <TryGetById>: <Reg8: 5, Reg8: 2, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r5 = globalThis.console;
    ...
    // USED → r3 = new globalThis.WeakMap(__uninitialized_this_for_new__r3).get;
    // CODE → <Call2>: <Reg8: 3, Reg8: 3, Reg8: 7, Reg8: 6>
    // USED → r3 = new globalThis.WeakMap(__uninitialized_this_for_new__r3).get(r6);
    // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
    console.log(r3)
    // CODE → <TryGetById>: <Reg8: 5, Reg8: 2, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r5 = globalThis.console;
