function switchInsideTryTest(param0, param1) {
    ...
    // USED → r0 = new globalThis.Error("case 1 throws", __uninitialized_this_for_new__r3);
    // CODE → <SelectObject>: <Reg8: 0, Reg8: 2, Reg8: 0>
    // USED → r0 = new globalThis.Error("case 1 throws", __uninitialized_this_for_new__r3);
    // CODE → <Throw>: <Reg8: 0>
    throw new globalThis.Error("case 1 throws", __uninitialized_this_for_new__r3);
    // ──────────────── Block 4 ──────────────── 
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r3 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
