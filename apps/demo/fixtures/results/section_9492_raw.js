function spreadArrayTest(param0) {
    ...
    r5 = undefined
    // CODE → <JmpTrue>: <Addr8: 6, Reg8: 6>  # Address: 0000009b
    if (GetIterator(r7) === undefined) goto label_155;
    // ──────────────── Block 1 ──────────────── 
    ...
    // USED → r2 = 0;
    // CODE → <JmpTrue>: <Addr8: 43, Reg8: 6>  # Address: 000000cc
    ...
    r2 = globalThis.console.log(GetIterator(r7).next(), r4)
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 1, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r3 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 2, Reg8: 3, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
    // USED → r2 = globalThis.console.log;
