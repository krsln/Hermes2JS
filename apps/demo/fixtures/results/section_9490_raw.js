function callDestructuringTests(param0) {
    ...
    if ({ "page": 1 }.page !== undefined) goto label_74;
    // ──────────────── Block 1 ──────────────── 
    ...
    if ({ "timeout": 500 }.timeout !== undefined) goto label_157;
    // ──────────────── Block 3 ──────────────── 
    ...
    if ({ "timeout": 500 }.retries !== undefined) goto label_170;
    // ──────────────── Block 5 ──────────────── 
    ...
    if ({ "id": 7 }.name !== undefined) goto label_242;
    // ──────────────── Block 7 ──────────────── 
    ...
    if (GetIterator(r6) === undefined) goto label_314;
    // ──────────────── Block 14 ──────────────── 
    ...
    if (GetIterator(r6) === undefined) goto label_486;
    // ──────────────── Block 21 ──────────────── 
    // CODE → <IteratorClose>: <Reg8: 5, UInt8: 0>
    GetIterator(r6).return()
    // ──────────────── Block 22 ──────────────── 
