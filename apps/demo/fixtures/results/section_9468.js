function makeSound(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4618>  # String: '__BC:Classes/ClassTests/Dog/makeSound-override' (String)
    ...
    // CODE → <GetByIdWithReceiverLong>: <Reg8: 3, Reg8: 3, UInt8: 2, Reg8: 1, string_id: 10392>  # String: 'makeSound' (Identifier)
    ...
    // USED → r3 = this.name;
    // CODE → <GetById>: <Reg8: 2, Reg8: 1, UInt8: 4, string_id: 15980>  # String: 'breed' (Identifier)
    // USED → r2 = this.breed;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 1810>  # String: 'is a' (String)
    // USED → r1 = "is a";
