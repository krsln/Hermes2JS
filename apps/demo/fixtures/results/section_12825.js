function function_12825(param0, param1, param2, param3, param4) {
    ...
    while (!param1.slice().length) {
        ...
        if (!param1.slice().length) { /* jump to label_128 */ }
        // ──────────────── Block 2 ──────────────── 
        ...
        // USED → r1 = param1.slice().pop()(param2)
        // CODE → <StrictEq>: <Reg8: 0, Reg8: 1, Reg8: 5>
        // USED → r0 = param1.slice().pop()(param2) === false
        // CODE → <Jmp>: <Addr8: 47>  # Address: 0000007a
        goto label_122;
        // LOOP → START (while)
        while (!param1.slice().pop()(param2) === false) {
            // ──────────────── Block 4 ──────────────── 
            // CODE → <Mov>: <Reg8: 1, Reg8: 0>
            // USED → r1 = param1.slice().pop()(param2) === false
            // CODE → <JmpFalse>: <Addr8: -86, Reg8: 1>  # Address: 00000027
            if (!param1.slice().pop()(param2) === false) { /* jump to label_39 */ }
            // ──────────────── Block 3 ──────────────── 
            // CODE → <Catch>: <Reg8: 12>
    ...
    // ──────────────── Block 5 ──────────────── 
    // CODE → <Ret>: <Reg8: 0>
    return param1.slice().pop()(param2) === false;
}