async function* anon_11947(param0, param1, param2) {
    ...
    if (!caughtException instanceof globalThis.Error) { /* jump to 316 */ }
    // Block 6
    r6 = {}
    r4 = globalThis.Error
    r4 = globalThis.Error.captureStackTrace
    r8 = globalThis.Error
    if (globalThis.Error.captureStackTrace) { /* jump to 121 */ }
    // Block 7
    ...
    if (globalThis.String(r1.stack) { /* jump to 312 */ }
    // Block 15
    r3 = r1
    r4 = r1.stack
    r5 = r2
