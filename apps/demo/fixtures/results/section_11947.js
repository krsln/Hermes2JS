async function* anon_11947(param0, param1, param2) {
    ...
    if (r3.Error.captureStackTrace) { /* jump to label_121 */ }
    // ──────────────── Block 7 ──────────────── 
    ...
    // USED → r7 = createThis(prototype=r3.Error.prototype, constructor=r3.Error)
    // CODE → <Mov>: <Reg8: 12, Reg8: 7>
    r12 = createThis(prototype=r3.Error.prototype, constructor=r3.Error)
    // CODE → <Construct>: <Reg8: 4, Reg8: 8, UInt8: 1>
    r4 = new r3.Error(createThis(prototype=r3.Error.prototype, constructor=r3.Error))
    ...
    r4 = r3.Error.captureStackTrace(r3.Error, r4)
    // ──────────────── Block 9 ──────────────── 
    // CODE → <Mov>: <Reg8: 4, Reg8: 6>
    // USED → r4 = r7[r4]
    ...
    // USED → r5 = r3.String(undefined, r3.stack)
