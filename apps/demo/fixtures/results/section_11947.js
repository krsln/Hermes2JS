async function* anon_11947(param0, param1, param2) {
    ...
    if (!(caughtException instanceof r3.Error)) goto label_316;
    // ──────────────── Block 6 ──────────────── 
    ...
    caughtException.stack = r6.stack.replace(r6.stack, /^.+\\n/, "");
    ...
    // USED → r5 = r3.String(undefined, caughtException.stack);
    // CODE → <GetById>: <Reg8: 4, Reg8: 5, UInt8: 8, string_id: 19080>  # String: 'endsWith' (Identifier)
    // USED → r4 = r3.String(undefined, caughtException.stack).endsWith;
    ...
    // USED → r3 = r3.String(undefined, caughtException.stack).endsWith(r3.String(undefined, caughtException.stack), r6.stack.replace(r6.stack, /^.+\\n/, "").replace(r6.stack.replace(r6.stack, /^.+\\n/, ""), /^.+\\n.+\\n/, ""));
    // CODE → <JmpTrue>: <Addr8: 33, Reg8: 3>  # Address: 00000138
    if (r3.String(undefined, caughtException.stack).endsWith(r3.String(undefined, caughtException.stack), r6.stack.replace(r6.stack, /^.+\\n/, "").replace(r6.stack.replace(r6.stack, /^.+\\n/, ""), /^.+\\n.+\\n/, ""))) goto label_312;
    // ──────────────── Block 15 ──────────────── 
    // CODE → <Mov>: <Reg8: 3, Reg8: 1>
    // USED → r3 = caughtException;
