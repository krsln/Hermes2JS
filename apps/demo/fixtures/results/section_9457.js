function spreadObjectTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4700>  # String: '__BC:Arrays/SpreadTests/spreadObjectTest/start' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4699>  # String: '__BC:Arrays/SpreadTests/spreadObjectTest/end' (String)
