function tryCatchFinallyImplicitThrowTest(param0, param1) {
    ...
    r0 = globalThis.console.log("__BC:Exceptions/ExceptionTests/tryCatchFinallyImplicitThrowTest/start")
    ...
    r2 = globalThis.console.log("__BC:Exceptions/ExceptionTests/tryCatchFinallyImplicitThrowTest/result", getParentEnvironment(0)[0].call(0, param1))
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 1, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
