function defaultWithRestTest(param0) {
    ...
    // USED → r4 = apply(r3, r4).reduce(function_12481, (param1 !== undefined) ? param1 : 1);
    ...
    r2 = globalThis.console.log(apply(r3, r4).reduce(function_12481, (param1 !== undefined) ? param1 : 1))
    // CODE → <Ret>: <Reg8: 1>
    return undefined;
}