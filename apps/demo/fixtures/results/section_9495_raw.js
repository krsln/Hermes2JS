function mapTest() {
    ...
    r3 = new globalThis.Map().set("alice", r4)
    // CODE → <GetByIdShort>: <Reg8: 5, Reg8: 2, UInt8: 4, string_id: 55>  # String: 'set' (Identifier)
    // USED → r5 = new globalThis.Map().set;
    ...
    r3 = new globalThis.Map().set("carol", r5)
    ...
    // USED → r3 = new globalThis.Map().get;
    // CODE → <Call2>: <Reg8: 3, Reg8: 3, Reg8: 2, Reg8: 4>
    // USED → r3 = new globalThis.Map().get("bob");
    ...
    // USED → r3 = new globalThis.Map().delete;
    // CODE → <Call2>: <Reg8: 3, Reg8: 3, Reg8: 2, Reg8: 4>
    r3 = new globalThis.Map().delete("bob")
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 1, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
