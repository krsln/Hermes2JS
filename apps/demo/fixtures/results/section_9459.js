function arrowFunctionTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4756>  # String: '__BC:Functions/ArrowTests/arrowFunctionTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 5, UInt16: 4, UInt16: 4, UInt16: 36995>  # Array: [1, 2, 3, 4]
    // USED → r5 = [1, 2, 3, 4];
    // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 2, string_id: 125>  # String: 'map' (Identifier)
    // USED → r4 = [1, 2, 3, 4].map;
    // CODE → <LoadConstUndefined>: <Reg8: 1>
    // USED → r1 = undefined;
    // CODE → <CreateClosure>: <Reg8: 3, Reg8: 1, function_id: 12404>  # Function: [#12404  of 12 bytes]: 2 params @ offset 0x0023e3a7
    // USED → r3 = function_12404;
    // CODE → <Call2>: <Reg8: 5, Reg8: 4, Reg8: 5, Reg8: 3>
    // USED → r5 = [1, 2, 3, 4].map(function_12404);
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 2, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    // CODE → <Call2>: <Reg8: 3, Reg8: 3, Reg8: 4, Reg8: 5>
    r3 = globalThis.console.log([1, 2, 3, 4].map(function_12404))
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 2, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    ...
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2021>  # String: '__BC:Functions/ArrowTests/arrowFunctionTest/end' (String)
