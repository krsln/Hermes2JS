function function_10679(param0, param1, param2, param3, param4, param5, param6, param7) {
    ...
    // USED → r0 = processPathConstants /* Closure with env r3 = createEnvironment() */
    // CODE → <StoreToEnvironment>: <Reg8: 3, UInt8: 7, Reg8: 0>
    createEnvironment()[7] = processPathConstants /* Closure with env r3 = createEnvironment() */
    ...
    // USED → r1 = r5(undefined, r6[0])
    // CODE → <StoreToEnvironment>: <Reg8: 3, UInt8: 2, Reg8: 1>
    createEnvironment()[2] = r5(undefined, r6[0])
    ...
    // USED → r1 = { SDK_VERSION: r5(undefined, r6[2]) }
    ...
    // USED → r1 = Object.defineProperty({ SDK_VERSION: r5(undefined, r6[2]) }, "FilePath", { get: get FilePath /* Closure with env r3 = createEnvironment() */, set: undefined, enumerable: true, configurable: true })
    // CODE → <PutById>: <Reg8: 2, Reg8: 1, UInt8: 1, string_id: 110>  # String: 'default' (Identifier)
    r2 = { default: Object.defineProperty({ SDK_VERSION: r5(undefined, r6[2]) }, "FilePath", { get: get FilePath /* Closure with env r3 = createEnvironment() */, set: undefined, enumerable: true, configurable: true }) }
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}