function function_10679(param0, param1, param2, param3, param4, param5, param6, param7) {
    ...
    r0 = r0.Object.defineProperty(r2, "__esModule", r1)
    ...
    createEnvironment()[2] = param2(r6[0]);
    ...
    // USED → r1 = Object.defineProperty({ SDK_VERSION: param2(r6[2]) }, "FilePath", { get: get FilePath /* Closure with env r3 = createEnvironment() */, set: undefined, enumerable: true, configurable: true })
    // CODE → <PutById>: <Reg8: 2, Reg8: 1, UInt8: 1, string_id: 110>  # String: 'default' (Identifier)
    r2 = { default: Object.defineProperty({ SDK_VERSION: param2(r6[2]) }, "FilePath", { get: get FilePath /* Closure with env r3 = createEnvironment() */, set: undefined, enumerable: true, configurable: true }) }
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}