function function_10679(param0, param1, param2, param3, param4, param5, param6, param7) {
    ...
    // USED → r1 = { SDK_VERSION: param2.call(undefined, param7[2]) };
    ...
    Object.defineProperty({ SDK_VERSION: param2.call(undefined, param7[2]) }, "FilePath", { get: get FilePath, set: undefined, enumerable: true, configurable: true });
    // CODE → <PutById>: <Reg8: 2, Reg8: 1, UInt8: 1, string_id: 110>  # String: 'default' (Identifier)
    param6.default = { SDK_VERSION: param2.call(undefined, param7[2]) };
    // CODE → <Ret>: <Reg8: 0>
    return undefined;
}