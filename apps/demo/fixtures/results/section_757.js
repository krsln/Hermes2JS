function isRenderConsistentWithExternalStores(param0, param1) {
    ...
    while (!param1.flags & 16384) {
        ...
        if (!param1.flags & 16384) { /* jump to label_158 */ }
        // ──────────────── Block 2 ──────────────── 
        ...
        if (null === param1.updateQueue) { /* jump to label_158 */ }
        // ──────────────── Block 3 ──────────────── 
        ...
        if (null === param1.updateQueue.stores) { /* jump to label_158 */ }
        // ──────────────── Block 4 ──────────────── 
        ...
        if (0 >= param1.updateQueue.stores.length) { /* jump to label_158 */ }
        // ──────────────── Block 8 ──────────────── 
        ...
        if (!param1.subtreeFlags & 16384) { /* jump to label_183 */ }
        // ──────────────── Block 9 ──────────────── 
        // CODE → <Mov>: <Reg8: 11, Reg8: 6>
        // USED → r11 = param1.child
        // CODE → <JStrictNotEqual>: <Addr8: 98, Reg8: 4, Reg8: 11>  # Address: 00000115
        if (null !== param1.child) { /* jump to label_277 */ }
        // ──────────────── Block 10 ──────────────── 
        ...
        if (null !== param1.sibling) { /* jump to label_243 */ }
        // ──────────────── Block 15 ──────────────── 
        ...
        r14 = { return: param1.return.return }
        ...
        while (r14(r13[0].getSnapshot(), r13[0].value)) {
            ...
            if (0 + 1 < param1.updateQueue.stores.length) { /* jump to label_86 */ }
        }
        // LOOP → END
        // LOOP → START (while)
        while (null === param1.return) {
            // ──────────────── Block 12 ──────────────── 
            ...
            if (null === param1.return) { /* jump to label_269 */ }
            // ──────────────── Block 13 ──────────────── 
            ...
            if (param1.return === param1) { /* jump to label_269 */ }
            // ──────────────── Block 14 ──────────────── 
            // CODE → <GetByIdShort>: <Reg8: 15, Reg8: 13, UInt8: 10, string_id: 209>  # String: 'return' (Identifier)
            // USED → r15 = param1.return
            ...
            if (null === param1.return.sibling) { /* jump to label_202 */ }
        }
        // LOOP → END
    }
    // LOOP → END
