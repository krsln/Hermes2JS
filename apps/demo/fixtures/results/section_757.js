function isRenderConsistentWithExternalStores(param0, param1) {
    ...
    while (!r10.flags & 16384) {
        ...
        // USED → r11 = r10.updateQueue.stores.length
        // CODE → <JNotLess>: <Addr8: 76, Reg8: 2, Reg8: 11>  # Address: 0000009e
        if (0 >= r10.updateQueue.stores.length) { /* jump to label_158 */ }
        // ──────────────── Block 5 ──────────────── 
        // CODE → <Mov>: <Reg8: 13, Reg8: 6>
        // USED → r13 = r10.updateQueue.stores
        // CODE → <Mov>: <Reg8: 11, Reg8: 7>
        // USED → r11 = 0
        // CODE → <GetByVal>: <Reg8: 11, Reg8: 13, Reg8: 11>
        // USED → r11 = r10.updateQueue.stores[0]
        // CODE → <Mov>: <Reg8: 8, Reg8: 11>
        r8 = r10.updateQueue.stores[0]
        // CODE → <GetById>: <Reg8: 9, Reg8: 11, UInt8: 5, string_id: 23581>  # String: 'getSnapshot' (Identifier)
        // USED → r9 = r10.updateQueue.stores[0].getSnapshot
        // CODE → <GetByIdShort>: <Reg8: 8, Reg8: 11, UInt8: 6, string_id: 249>  # String: 'value' (Identifier)
        // USED → r8 = r10.updateQueue.stores[0].value
        // CODE → <LoadFromEnvironment>: <Reg8: 14, Reg8: 1, UInt8: 73>
        // USED → r14 = getEnvironment(0)[73]
        // CODE → <Mov>: <Reg8: 11, Reg8: 9>
        // USED → r11 = r10.updateQueue.stores[0].getSnapshot
        // CODE → <Call1>: <Reg8: 13, Reg8: 11, Reg8: 5>
        // USED → r13 = r10.updateQueue.stores[0].getSnapshot(undefined)
        // CODE → <Mov>: <Reg8: 11, Reg8: 8>
        // USED → r11 = r10.updateQueue.stores[0].value
        // CODE → <Call3>: <Reg8: 11, Reg8: 14, Reg8: 5, Reg8: 13, Reg8: 11>
        // USED → r11 = getEnvironment(0)[73](undefined, r10.updateQueue.stores[0].getSnapshot(undefined), r10.updateQueue.stores[0].value)
        // CODE → <JmpTrue>: <Addr8: 7, Reg8: 11>  # Address: 00000089
        if (getEnvironment(0)[73](undefined, r10.updateQueue.stores[0].getSnapshot(undefined), r10.updateQueue.stores[0].value)) { /* jump to label_137 */ }
        // ──────────────── Block 7 ──────────────── 
        // CODE → <Mov>: <Reg8: 11, Reg8: 7>
        // USED → r11 = 0
        ...
        if (0 + 1 < r10.updateQueue.stores.length) { /* jump to label_86 */ }
        // ──────────────── Block 8 ──────────────── 
        ...
        if (null !== r10.sibling) { /* jump to label_243 */ }
        // ──────────────── Block 12 ──────────────── 
        ...
        if (null === r10.return) { /* jump to label_269 */ }
        // ──────────────── Block 13 ──────────────── 
