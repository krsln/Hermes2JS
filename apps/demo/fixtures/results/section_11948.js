function _request(param0, param1, param2) {
    ...
    r2 = r2.default.assertOptions(r10.transitional, { silentJSONParsing: r21.transitional(r21.boolean), forcedJSONParsing: r21.transitional(r21.boolean), clarifyTimeoutError: r21.transitional(r21.boolean) }, false)
    // ──────────────── Block 9 ──────────────── 
    // CODE → <LoadConstNull>: <Reg8: 2>
    // USED → r2 = null
    // CODE → <JEqual>: <Addr8: 94, Reg8: 14, Reg8: 2>  # Address: 00000141
    if (r10.paramsSerializer == null) { /* jump to label_321 */ }
    // ──────────────── Block 10 ──────────────── 
    ...
    // USED → r2 = r2.default.isFunction(r10.paramsSerializer)
    // CODE → <JmpTrue>: <Addr8: 57, Reg8: 2>  # Address: 00000134
    if (r2.default.isFunction(r10.paramsSerializer)) { /* jump to label_308 */ }
    // ──────────────── Block 11 ──────────────── 
    // CODE → <LoadFromEnvironment>: <Reg8: 2, Reg8: 6, UInt8: 9>
    r2 = r6[9]
    // CODE → <GetByIdShort>: <Reg8: 18, Reg8: 2, UInt8: 1, string_id: 110>  # String: 'default' (Identifier)
    ...
    r2 = r2.default.assertOptions(r10.paramsSerializer, { encode: r2.function, serialize: r2.function }, true)
    ...
    // USED → r2 = { serialize: r10.paramsSerializer }
    // CODE → <PutById>: <Reg8: 10, Reg8: 2, UInt8: 2, string_id: 15117>  # String: 'paramsSerializer' (Identifier)
    // USED → r10 = { paramsSerializer: { serialize: r10.paramsSerializer } }
    // ──────────────── Block 13 ──────────────── 
    ...
    // USED → r10 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: true }
    ...
    // USED → r2 = r8.defaults.allowAbsoluteUrls
    // CODE → <PutById>: <Reg8: 10, Reg8: 2, UInt8: 3, string_id: 12108>  # String: 'allowAbsoluteUrls' (Identifier)
    // USED → r10 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls }
    // ──────────────── Block 17 ──────────────── 
    // CODE → <LoadFromEnvironment>: <Reg8: 2, Reg8: 6, UInt8: 9>
    r2 = r6[9]
    ...
    r14 = r2.default.assertOptions({ paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls }, { baseUrl: r19.spelling("baseURL"), withXsrfToken: r19.spelling("withXSRFToken") }, true)
    ...
    // USED → r10 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase() }
    // CODE → <Mov>: <Reg8: 16, Reg8: 17>
    // USED → r16 = r10.headers
    // CODE → <JmpFalse>: <Addr8: 40, Reg8: 16>  # Address: 00000214
    if (!r10.headers) { /* jump to label_532 */ }
    // ──────────────── Block 22 ──────────────── 
    ...
    // USED → r14 = r14.default.concat(r14.default.merge(r10.headers.common, r10.headers[r10.method]), r10.headers)
    // CODE → <PutById>: <Reg8: 10, Reg8: 14, UInt8: 5, string_id: 145>  # String: 'headers' (Identifier)
    // USED → r10 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r14.default.merge(r10.headers.common, r10.headers[r10.method]), r10.headers) }
    ...
    r2 = r8.interceptors.request.forEach(unshiftRequestInterceptors /* Closure with env r9 = undefined */)
    ...
    // CODE → <Call2>: <Reg8: 2, Reg8: 14, Reg8: 15, Reg8: 2>
    r2 = r8.interceptors.response.forEach(pushResponseInterceptors /* Closure with env r9 = undefined */)
    ...
    r9 = r15.unshift.apply([r9.default.bind(this), undefined], [])
    ...
    // USED → r9 = []
    // CODE → <Call3>: <Reg8: 9, Reg8: 14, Reg8: 16, Reg8: 15, Reg8: 9>
    r9 = r15.push.apply([r9.default.bind(this), undefined], [])
    ...
    // USED → r0 = r9.Promise.resolve({ paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r14.default.merge(r10.headers.common, r10.headers[r10.method]), r10.headers) })
    ...
    // USED → r18 = r9.Promise.resolve({ paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r14.default.merge(r10.headers.common, r10.headers[r10.method]), r10.headers) })
    ...
    // USED → r1 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r14.default.merge(r10.headers.common, r10.headers[r10.method]), r10.headers) }
    // CODE → <LoadConstZero>: <Reg8: 4>
    // USED → r4 = 0
    ...
    // USED → r0 = r0.Promise.reject(caughtException)
    // CODE → <Ret>: <Reg8: 0>
    return r0.Promise.reject(caughtException);
}