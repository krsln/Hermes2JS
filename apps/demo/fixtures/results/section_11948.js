function _request(param0, param1, param2) {
    ...
    // USED → r0 = r9.Promise.resolve(r9.Promise, r10).then(r9.Promise.resolve(r9.Promise, r10), [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, r8), undefined] /* capacity hint: 2 */[+0], [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, r8), undefined] /* capacity hint: 2 */[++0 + 1])
    ...
    // USED → r9 = r9.Promise.resolve(r9.Promise, r10).then(r9.Promise.resolve(r9.Promise, r10), [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, r8), undefined] /* capacity hint: 2 */[+0], [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, r8), undefined] /* capacity hint: 2 */[++0 + 1])
    // CODE → <Ret>: <Reg8: 9>
    return r9.Promise.resolve(r9.Promise, r10).then(r9.Promise.resolve(r9.Promise, r10), [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, r8), undefined] /* capacity hint: 2 */[+0], [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, r8), undefined] /* capacity hint: 2 */[++0 + 1]);
    // ──────────────── Block 29 ──────────────── 
    // CODE → <Mov>: <Reg8: 9, Reg8: 12>
    // USED → r9 = []
    ...
    while (0 >= [].length) {
        ...
        // USED → r0 = getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9))
        // CODE → <LoadConstZero>: <Reg8: 4>
        // USED → r4 = 0
    ...
    // USED → r8 = getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9))
    // CODE → <GetByIdShort>: <Reg8: 7, Reg8: 8, UInt8: 28, string_id: 231>  # String: 'then' (Identifier)
    // USED → r7 = getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9)).then
    // CODE → <Mov>: <Reg8: 9, Reg8: 3>
    // USED → r9 = []
    ...
    // USED → r0 = getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9)).then(getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9)), [][+0], [][++0 + 1])
    ...
    // ──────────────── Block 35 ──────────────── 
    // CODE → <Ret>: <Reg8: 0>
    return getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9)).then(getEnvironment(1)[6].default.call(getEnvironment(1)[6].default, r8, [][+0](undefined, r9)), [][+0], [][++0 + 1]);
    // CODE → <Catch>: <Reg8: 2>
