function _request(param0, param1, param2) {
    ...
    // label_321:
    r2 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer } }.allowAbsoluteUrls
    // CODE -> <GetById>: <Reg8: 2, Reg8: 8, UInt8: 2, string_id: 14042>  # String: 'defaults' (Identifier)
    // USED -> r2 = param0.defaults
    // CODE -> <GetById>: <Reg8: 2, Reg8: 2, UInt8: 10, string_id: 12108>  # String: 'allowAbsoluteUrls' (Identifier)
    r2 = param0.defaults.allowAbsoluteUrls
    // CODE -> <LoadConstTrue>: <Reg8: 2>
    // USED -> r2 = true
    ...
    if (!r2.default(param0.defaults) {
        ...
        r14 = r14.default.forEach(r2.default(param0.defaults).headers.common, function_11949 /* Closure with env r9 = undefined */)
    }
    ...
    if (r9) {
        ...
        r14 = param0.interceptors.response.length
