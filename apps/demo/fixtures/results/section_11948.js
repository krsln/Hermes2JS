function _request(param0, param1, param2) {
    ...
    // USED → r10 = r2.default(r8.defaults, r14)
    // CODE → <StoreToEnvironment>: <Reg8: 9, UInt8: 0, Reg8: 10>
    createEnvironment()[0] = r2.default(r8.defaults, r14);
    ...
    r2 = r2.default.assertOptions(r10.transitional, r15, false)
    // ──────────────── Block 9 ──────────────── 
    ...
    r2 = r2.default.assertOptions(r10.paramsSerializer, r15, true)
    ...
    r14 = r2.default.assertOptions(r10, r14, true)
    ...
    r14 = r14.default.forEach(r15, r14)
    // ──────────────── Block 25 ──────────────── 
    ...
    // USED → r14 = r14.default.concat(r16, r10.headers)
    // CODE → <PutById>: <Reg8: 10, Reg8: 14, UInt8: 5, string_id: 145>  # String: 'headers' (Identifier)
    // USED → r10 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r16, r10.headers) }
    ...
    // USED → r1 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r16, r10.headers) }
    // CODE → <LoadConstZero>: <Reg8: 4>
    // USED → r4 = 0
    ...
    // USED → r9 = { paramsSerializer: { serialize: r10.paramsSerializer }, allowAbsoluteUrls: r8.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r16, r10.headers) }
