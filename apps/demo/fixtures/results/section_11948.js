function _request(param0, param1, param2) {
    ...
    r9 = // Create new environment
    // CODE -> <StoreToEnvironment>: <Reg8: 9, UInt8: 0, Reg8: 2>
    r9 = setEnvSlot(0, r2)  // StoreToEnvironment: env=r9, slot=0, value=r2
    ...
    if (typeof param1 === "string") {
        ...
        // label_52:
        r9 = setEnvSlot(0, r14)  // StoreToEnvironment: env=r9, slot=0, value=r14
    ...
    if (r2.default(param0.defaults) {
        ...
        // USED -> r2 = r2.default.isFunction(r2.default(param0.defaults).paramsSerializer)
        // CODE -> <JmpTrue>: <Addr8: 57, Reg8: 2>  # Address: 00000134
        if (r2.default.isFunction(r2.default(param0.defaults) {
            // CODE -> <LoadFromEnvironment>: <Reg8: 2, Reg8: 6, UInt8: 9>
            r2 = r6[9]
            // CODE -> <GetByIdShort>: <Reg8: 18, Reg8: 2, UInt8: 1, string_id: 110>  # String: 'default' (Identifier)
            // USED -> r18 = r2.default
        ...
        // USED -> r2 = { serialize: r2.default(param0.defaults).paramsSerializer }
        // CODE -> <PutById>: <Reg8: 10, Reg8: 2, UInt8: 2, string_id: 15117>  # String: 'paramsSerializer' (Identifier)
        // USED -> r10 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer } }
    }
    // CODE -> <GetById>: <Reg8: 2, Reg8: 10, UInt8: 10, string_id: 12108>  # String: 'allowAbsoluteUrls' (Identifier)
    // label_321:
    // USED -> r2 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer } }.allowAbsoluteUrls
    // CODE -> <JStrictNotEqual>: <Addr8: 48, Reg8: 2, Reg8: 11>  # Address: 00000177
    if ({ paramsSerializer: { serialize: r2.default(param0.defaults) {
        // CODE -> <GetById>: <Reg8: 2, Reg8: 8, UInt8: 2, string_id: 14042>  # String: 'defaults' (Identifier)
        // USED -> r2 = param0.defaults
        // CODE -> <GetById>: <Reg8: 2, Reg8: 2, UInt8: 10, string_id: 12108>  # String: 'allowAbsoluteUrls' (Identifier)
        // USED -> r2 = param0.defaults.allowAbsoluteUrls
        // CODE -> <JStrictNotEqual>: <Addr8: 14, Reg8: 2, Reg8: 11>  # Address: 00000165
        if (param0.defaults.allowAbsoluteUrls !== undefined) {
            // CODE -> <LoadConstTrue>: <Reg8: 2>
            // USED -> r2 = true
            // CODE -> <PutById>: <Reg8: 10, Reg8: 2, UInt8: 3, string_id: 12108>  # String: 'allowAbsoluteUrls' (Identifier)
            // USED -> r10 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer }, allowAbsoluteUrls: true }
        ...
        // USED -> r2 = param0.defaults.allowAbsoluteUrls
        // CODE -> <PutById>: <Reg8: 10, Reg8: 2, UInt8: 3, string_id: 12108>  # String: 'allowAbsoluteUrls' (Identifier)
        // USED -> r10 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer }, allowAbsoluteUrls: param0.defaults.allowAbsoluteUrls }
    }
    // CODE -> <LoadFromEnvironment>: <Reg8: 2, Reg8: 6, UInt8: 9>
    // label_375:
    r2 = r6[9]
    ...
    // USED -> r10 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer }, allowAbsoluteUrls: param0.defaults.allowAbsoluteUrls, method: "get".toLowerCase() }
    ...
    if (!r17) {
        ...
        // USED -> r15 = r2.default(param0.defaults).headers.common
        // CODE -> <GetById>: <Reg8: 14, Reg8: 10, UInt8: 12, string_id: 12916>  # String: 'method' (Identifier)
        r14 = { paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer }, allowAbsoluteUrls: param0.defaults.allowAbsoluteUrls, method: "get".toLowerCase() }.method
        // CODE -> <GetByVal>: <Reg8: 14, Reg8: 17, Reg8: 14>
        // USED -> r14 = r17[r14]
        // CODE -> <Call3>: <Reg8: 16, Reg8: 18, Reg8: 19, Reg8: 15, Reg8: 14>
        // USED -> r16 = r14.default.merge(r2.default(param0.defaults).headers.common, r17[r14])
    }
    ...
    r9 = setEnvSlot(4, r2)  // StoreToEnvironment: env=r9, slot=4, value=r2
    // CODE -> <GetById>: <Reg8: 2, Reg8: 8, UInt8: 18, string_id: 19835>  # String: 'interceptors' (Identifier)
    // USED -> r2 = param0.interceptors
    // CODE -> <GetById>: <Reg8: 15, Reg8: 2, UInt8: 20, string_id: 11767>  # String: 'response' (Identifier)
    // USED -> r15 = param0.interceptors.response
    // CODE -> <GetByIdShort>: <Reg8: 14, Reg8: 15, UInt8: 16, string_id: 135>  # String: 'forEach' (Identifier)
    // USED -> r14 = param0.interceptors.response.forEach
    ...
    // CODE -> <Call2>: <Reg8: 2, Reg8: 14, Reg8: 15, Reg8: 2>
    r2 = param0.interceptors.response.forEach(pushResponseInterceptors /* Closure with env r9 = undefined */)
    ...
    if (r9) {
        ...
        r0 = this.Promise.resolve({ paramsSerializer: { serialize: r2.default(param0.defaults).paramsSerializer }, allowAbsoluteUrls: param0.defaults.allowAbsoluteUrls, method: "get".toLowerCase(), headers: r14.default.concat(r14.default.merge(r2.default(param0.defaults).headers.common, r17[r14]), r2.default(param0.defaults).headers) })
        ...
        if (r4 >= [r9.default.bind(param0) {
            ...
            // Error: JLess at address 837: Expected 'Addr, Reg, Reg' arguments for JLess: Addr8: -46, Reg8: 14, Reg8: 9
        }
    ...
    if (0 >= r12.length) {
        ...
        // Error: JLess at address 912: Expected 'Addr, Reg, Reg' arguments for JLess: Addr8: -46, Reg8: 10, Reg8: 9
        ...
        r7 = r7.call(param0, caughtException)
    }
    ...
    r0 = r6.default.call(param0, r13(r1))
    // CODE -> <LoadConstZero>: <Reg8: 4>
    r4 = 0
    ...
    if (0 >= r3.length) {
        ...
        // Error: JLess at address 1020: Expected 'Addr, Reg, Reg' arguments for JLess: Addr8: -49, Reg8: 2, Reg8: 1
    }
    // CODE -> <Ret>: <Reg8: 0>
    // label_1024:
