function processColorsInProps(param0, param1) {
    ...
    while (r2 === undefined) {
        ...
        if (getEnvironment(1)[17].includes(getEnvironment(1)[17], r2)) { /* jump to label_158 */ }
        // ──────────────── Block 3 ──────────────── 
        ...
        if (!getEnvironment(1)[18][r2]) { /* jump to label_28 */ }
        // LOOP → START (while)
        while (true) {
            // ──────────────── Block 10 ──────────────── 
            ...
            // USED → r11 = getEnvironment(1)[36](undefined, r10[r2])
            // CODE → <PutByVal>: <Reg8: 10, Reg8: 12, Reg8: 11>
            r10[r2] = getEnvironment(1)[36](undefined, r10[r2]);
    ...
    // USED → r12 = GetIterator(r10[r2])
    // LOOP → START (while)
    while (r12 === undefined) {
        // ──────────────── Block 5 ──────────────── 
        // CODE → <IteratorNext>: <Reg8: 14, Reg8: 12, Reg8: 11>
        // USED → r14 = GetIterator(r10[r2]).next()
        ...
        if (r14[getEnvironment(1)[18][r2]] === undefined) { /* jump to label_149 */ }
        // ──────────────── Block 7 ──────────────── 
