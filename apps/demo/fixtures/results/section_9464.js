function Animal(param0, param1, param2) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 2556>  # String: '__BC:Classes/ClassTests/Animal/constructor' (String)
    ...
    // USED → r1 = param2;
    // CODE → <PutByIdStrict>: <Reg8: 0, Reg8: 1, UInt8: 1, string_id: 11493>  # String: 'sound' (Identifier)
