function callDefaultParameterTests(param0) {
    ...
    // USED → r5 = globalThis;
    // CODE → <TryGetById>: <Reg8: 8, Reg8: 5, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 4763>  # String: '__BC:Functions/DefaultParameterTests/callDefaultParameterTests/start' (String)
    ...
    // CODE → <TryGetById>: <Reg8: 7, Reg8: 5, UInt8: 0, string_id: 106>  # String: 'console' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 4764>  # String: '__BC:Functions/DefaultParameterTests/defaultParameterTest/start' (String)
    ...
    // USED → r0 = 15;
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 7699>  # String: 'result' (Identifier)
    // USED → r9 = "result";
    ...
    // CODE → <GetByIdShort>: <Reg8: 7, Reg8: 8, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r7 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 1393>  # String: 'sum' (String)
    // USED → r6 = "sum";
    ...
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 7, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r6 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 2449>  # String: '__BC:Functions/DefaultParameterTests/callDefaultParameterTests/end' (String)
