function ternaryTest(param1) {
    ...
    r6 = "positive"
    // CODE → <JmpTrue>: <Addr8: 21, Reg8: 0>  # Address: 00000038
    if (param1 > 0) goto label_56;
    // ──────────────── Block 1 ──────────────── 
    // CODE → <Less>: <Reg8: 0, Reg8: 3, Reg8: 2>
    // USED → r0 = param1 < 0;
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 597>  # String: 'zero' (String)
    r4 = "zero"
    // CODE → <JmpFalse>: <Addr8: 7, Reg8: 0>  # Address: 00000035
    ...
    // USED → r0 = param1 > 100;
    // CODE → <JmpTrue>: <Addr8: 18, Reg8: 0>  # Address: 00000061
    ...
    // CODE → <LoadConstZero>: <Reg8: 2>
    r2 = 0
    // CODE → <JmpTrue>: <Addr8: 6, Reg8: 0>  # Address: 0000005e
