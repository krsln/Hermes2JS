function ifElseChainTest(param0, param1, param2) {
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 4722>  # String: '__BC:ControlFlow/IfTests/ifElseChainTest/start' (String)
    ...
    if (!param1) {
        if (param1 || param2) {
            ...
            // CODE → <LoadConstString>: <Reg8: 3, string_id: 4718>  # String: '__BC:ControlFlow/IfTests/ifElseChainTest/branch-either' (String)
            ...
            // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r4 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 3, string_id: 1886>  # String: 'either' (String)
            // USED → r3 = "either";
            // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
            ...
            // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r4 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 3, string_id: 4719>  # String: '__BC:ControlFlow/IfTests/ifElseChainTest/branch-neither' (String)
            ...
            // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r4 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 3, string_id: 1885>  # String: 'neither' (String)
            // USED → r3 = "neither";
            // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
        ...
        // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
        // USED → r4 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 3, string_id: 4717>  # String: '__BC:ControlFlow/IfTests/ifElseChainTest/branch-both' (String)
        ...
        // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
        // USED → r4 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 3, string_id: 370>  # String: 'both' (String)
        // USED → r3 = "both";
        // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
    ...
    if (!param1) {
        ...
        // CODE → <LoadConstString>: <Reg8: 2, string_id: 4720>  # String: '__BC:ControlFlow/IfTests/ifElseChainTest/branch-not-a' (String)
        ...
        // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
        // USED → r3 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 2, string_id: 645>  # String: 'not a' (String)
        // USED → r2 = "not a";
        // CODE → <Call2>: <Reg8: 2, Reg8: 3, Reg8: 4, Reg8: 2>
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 3064>  # String: '__BC:ControlFlow/IfTests/ifElseChainTest/end' (String)
