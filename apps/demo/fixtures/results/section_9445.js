function complexTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 4708>  # String: '__BC:ControlFlow/ComplexTests/complexTest/start' (String)
    ...
    // CODE → <NewArrayWithBuffer>: <Reg8: 14, UInt16: 5, UInt16: 5, UInt16: 4428>  # Array: [1, 2, 3, 4, 5]
    // USED → r14 = [1, 2, 3, 4, 5];
    ...
    // CODE → <LoadConstString>: <Reg8: 12, string_id: 758>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-2-continue' (String)
    // USED → r12 = "__BC:ControlFlow/ComplexTests/complexTest/case-2-continue";
    // CODE → <LoadConstString>: <Reg8: 11, string_id: 4216>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-3' (String)
    // USED → r11 = "__BC:ControlFlow/ComplexTests/complexTest/case-3";
    // CODE → <LoadConstString>: <Reg8: 10, string_id: 10180>  # String: 'three' (Identifier)
    // USED → r10 = "three";
    // CODE → <LoadConstString>: <Reg8: 9, string_id: 4705>  # String: '__BC:ControlFlow/ComplexTests/complexTest/case-default' (String)
    // USED → r9 = "__BC:ControlFlow/ComplexTests/complexTest/case-default";
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 1856>  # String: 'other' (String)
    // USED → r8 = "other";
    ...
    // USED → r7 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 6, string_id: 1863>  # String: '__BC:ControlFlow/ComplexTests/complexTest/end' (String)
