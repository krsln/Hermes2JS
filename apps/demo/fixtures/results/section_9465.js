function classTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 1518>  # String: '__BC:Classes/ClassTests/classTest/start' (String)
    ...
    r4 = __uninitialized_this__
    if (typeof getParentEnvironment(0)[0] !== "<128>") {
        // ──────────────── Block 1 ──────────────── 
        // CODE → <LoadConstString>: <Reg8: 8, string_id: 4284>  # String: 'Trying to call a non-function' (String)
        r8 = "Trying to call a non-function"
        // CODE → <CallBuiltin>: <Reg8: 4, UInt8: 44, UInt8: 2>  # Built-in function: [#44 copyDataProperties]
        r4 = builtin_44(r2, r3)
    }
    // ──────────────── Block 2 ──────────────── 
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 3, UInt8: 2, string_id: 213>  # String: 'prototype' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 2550>  # String: '__BC:Classes/ClassTests/Animal/constructor' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 3337>  # String: 'Generic' (String)
    // USED → r4 = "Generic";
    // CODE → <PutByIdStrict>: <Reg8: 3, Reg8: 4, UInt8: 0, string_id: 186>  # String: 'name' (Identifier)
    Object.create(getParentEnvironment(0)[0].prototype).name = "Generic"
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 735>  # String: '...' (String)
    // USED → r4 = "...";
    // CODE → <PutByIdStrict>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 11460>  # String: 'sound' (Identifier)
    Object.create(getParentEnvironment(0)[0].prototype).sound = "..."
    // CODE → <GetById>: <Reg8: 4, Reg8: 3, UInt8: 3, string_id: 9459>  # String: 'makeSound' (Identifier)
    ...
    // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r4 = globalThis.console.log;
    // CODE → <GetById>: <Reg8: 3, Reg8: 3, UInt8: 4, string_id: 10992>  # String: 'description' (Identifier)
    ...
    // USED → r3 = __uninitialized_this__;
    // CODE → <LoadConstString>: <Reg8: 7, string_id: 1426>  # String: 'Woof' (String)
    r7 = "Woof"
    // CODE → <LoadConstString>: <Reg8: 8, string_id: 3581>  # String: 'Rex' (String)
    r8 = "Rex"
    // CODE → <Mov>: <Reg8: 9, Reg8: 3>
    r9 = __uninitialized_this__
    ...
    // USED → r3 = __uninitialized_this__[Reflect.construct(__getPrototypeOfNoTraps__(getParentEnvironment(0)[4]), [r3, r4, r5], getParentEnvironment(0)[1])];
    ...
    // CODE → <GetByIdShort>: <Reg8: 5, Reg8: 6, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
    // USED → r5 = globalThis.console.log;
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2226>  # String: '__BC:Classes/ClassTests/Dog/constructor' (String)
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2344>  # String: 'Labrador' (String)
    // USED → r2 = "Labrador";
    // CODE → <PutByIdStrict>: <Reg8: 3, Reg8: 2, UInt8: 2, string_id: 15973>  # String: 'breed' (Identifier)
    __uninitialized_this__[Reflect.construct(__getPrototypeOfNoTraps__(getParentEnvironment(0)[4]), [r3, r4, r5], getParentEnvironment(0)[1])].breed = "Labrador"
    // CODE → <GetById>: <Reg8: 2, Reg8: 3, UInt8: 3, string_id: 9459>  # String: 'makeSound' (Identifier)
    // USED → r2 = __uninitialized_this__[Reflect.construct(__getPrototypeOfNoTraps__(getParentEnvironment(0)[4]), [r3, r4, r5], getParentEnvironment(0)[1])].makeSound;
    // CODE → <Call1>: <Reg8: 2, Reg8: 2, Reg8: 3>
    r2 = __uninitialized_this__[Reflect.construct(__getPrototypeOfNoTraps__(getParentEnvironment(0)[4]), [r3, r4, r5], getParentEnvironment(0)[1])].makeSound()
    // CODE → <GetById>: <Reg8: 2, Reg8: 3, UInt8: 3, string_id: 9459>  # String: 'makeSound' (Identifier)
    // USED → r2 = __uninitialized_this__[Reflect.construct(__getPrototypeOfNoTraps__(getParentEnvironment(0)[4]), [r3, r4, r5], getParentEnvironment(0)[1])].makeSound;
    // CODE → <Call1>: <Reg8: 2, Reg8: 2, Reg8: 3>
    r2 = __uninitialized_this__[Reflect.construct(__getPrototypeOfNoTraps__(getParentEnvironment(0)[4]), [r3, r4, r5], getParentEnvironment(0)[1])].makeSound()
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 5, string_id: 42>  # String: 'create' (Identifier)
    // USED → r3 = getParentEnvironment(0)[1].create;
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 2724>  # String: 'Buddy' (String)
    // USED → r2 = "Buddy";
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4704>  # String: '__BC:Classes/ClassTests/classTest/end' (String)
