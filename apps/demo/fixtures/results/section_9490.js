function callDestructuringTests(param0) {
    ...
    // USED → r7 = ({ "page": 1 }.page !== undefined) ? { "page": 1 }.page : 1;
    ...
    // USED → r9 = ({ "timeout": 500 }.timeout !== undefined) ? { "timeout": 500 }.timeout : 1000;
    // ──────────────── Block 4 ──────────────── 
    // CODE → <GetById>: <Reg8: 8, Reg8: 5, UInt8: 5, string_id: 9071>  # String: 'retries' (Identifier)
    // USED → r8 = ({ "timeout": 500 }.retries !== undefined) ? { "timeout": 500 }.retries : 3;
    // ──────────────── Block 6 ──────────────── 
    ...
    r6 = globalThis.console.log(({ "timeout": 500 }.timeout !== undefined) ? { "timeout": 500 }.timeout : 1000, ({ "timeout": 500 }.retries !== undefined) ? { "timeout": 500 }.retries : 3)
    ...
    // USED → r9 = ({ "id": 7 }.name !== undefined) ? { "id": 7 }.name : "anon";
    // ──────────────── Block 8 ──────────────── 
    ...
    r14 = ({ "id": 7 }.name !== undefined) ? { "id": 7 }.name : "anon"
    ...
    r7 = []
    // CODE → <IteratorNext>: <Reg8: 7, Reg8: 5, Reg8: 7>
    // USED → r7 = (GetIterator(r6) === undefined) ? undefined : GetIterator(r6).next();
    // CODE → <Mov>: <Reg8: 8, Reg8: 5>
    // USED → r8 = GetIterator(r6);
    // CODE → <StrictEq>: <Reg8: 1, Reg8: 8, Reg8: 2>
    // USED → r1 = GetIterator(r6) === undefined || GetIterator(r6) === undefined;
    // CODE → <LoadConstUndefined>: <Reg8: 8>
    r8 = (GetIterator(r6) === undefined) ? undefined : (GetIterator(r6) === undefined) ? undefined : GetIterator(r6).next()
    // ──────────────── Block 17 ──────────────── 
    // CODE → <LoadConstUndefined>: <Reg8: 7>
    r7 = undefined
    if (GetIterator(r6) !== undefined) {
        // ──────────────── Block 18 ──────────────── 
        // CODE → <IteratorNext>: <Reg8: 6, Reg8: 5, Reg8: 6>
        // USED → r6 = (GetIterator(r6) === undefined) ? undefined : (GetIterator(r6) === undefined) ? undefined : GetIterator(r6).next();
        // CODE → <Mov>: <Reg8: 9, Reg8: 5>
        // USED → r9 = GetIterator(r6);
        // CODE → <StrictEq>: <Reg8: 3, Reg8: 9, Reg8: 2>
        // USED → r3 = GetIterator(r6) === undefined || GetIterator(r6) === undefined;
        // CODE → <LoadConstUndefined>: <Reg8: 7>
        r7 = undefined
        // CODE → <Mov>: <Reg8: 1, Reg8: 3>
        r1 = GetIterator(r6) === undefined || GetIterator(r6) === undefined || (GetIterator(r6) === undefined || GetIterator(r6) === undefined)
    }
    if (GetIterator(r6) !== undefined) {
        // ──────────────── Block 21 ──────────────── 
        // CODE → <IteratorClose>: <Reg8: 5, UInt8: 0>
    ...
    r5 = globalThis.console.log((GetIterator(r6) === undefined) ? undefined : (GetIterator(r6) === undefined) ? undefined : GetIterator(r6).next(), (GetIterator(r6) === undefined) ? undefined : (GetIterator(r6) === undefined) ? undefined : GetIterator(r6).next())
    // CODE → <TryGetById>: <Reg8: 7, Reg8: 4, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r7 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 6, Reg8: 7, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
    // USED → r6 = globalThis.console.log;
