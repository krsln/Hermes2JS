function function_467(param0, param1, param2, param3, param4, param5, param6, param7) {
    ...
    {  }."preventDefault" = preventDefault /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."stopPropagation" = stopPropagation /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."persist" = persist /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutNewOwnById>: <Reg8: 37, Reg8: 42, string_id: 23978>  # String: 'isPersistent' (Identifier)
    {  }."isPersistent" = functionThatReturnsFalse /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."destructor" = destructor /* Closure with env r1 = createEnvironment() */;
    // CODE → <Call3>: <Reg8: 37, Reg8: 41, Reg8: 2, Reg8: 40, Reg8: 37>
    r37 = globalThis.Object.assign(undefined, SyntheticEvent /* Closure with env r1 = createEnvironment() */.prototype, {  })
    ...
    r37.currentTarget = currentTarget /* Closure with env r1 = createEnvironment() */;
    ...
    r37.timeStamp = timeStamp /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutById>: <Reg8: 39, Reg8: 37, UInt8: 3, string_id: 18542>  # String: 'Interface' (Identifier)
    SyntheticEvent /* Closure with env r1 = createEnvironment() */.Interface = r37;
    ...
    SyntheticEvent /* Closure with env r1 = createEnvironment() */.extend = function_811 /* Closure with env r1 = createEnvironment() */;
    // CODE → <Call2>: <Reg8: 17, Reg8: 17, Reg8: 2, Reg8: 39>
    r17 = addEventPoolingTo /* Closure with env r1 = createEnvironment() */(undefined, SyntheticEvent /* Closure with env r1 = createEnvironment() */)
    // CODE → <GetById>: <Reg8: 37, Reg8: 39, UInt8: 6, string_id: 14224>  # String: 'extend' (Identifier)
    // USED → r37 = SyntheticEvent /* Closure with env r1 = createEnvironment() */.extend
    ...
    {  }."touchHistory" = touchHistory /* Closure with env r1 = createEnvironment() */;
    // CODE → <Call2>: <Reg8: 17, Reg8: 37, Reg8: 39, Reg8: 17>
    // USED → r17 = SyntheticEvent /* Closure with env r1 = createEnvironment() */.extend(SyntheticEvent /* Closure with env r1 = createEnvironment() */, {  })
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 9, Reg8: 17>
    createEnvironment()[9] = SyntheticEvent /* Closure with env r1 = createEnvironment() */.extend(SyntheticEvent /* Closure with env r1 = createEnvironment() */, {  })
    ...
    {  }."instrument" = instrument /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."recordTouchTrack" = recordTouchTrack /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."dependencies" = ["topTouchCancel", "topTouchEnd"];
    ...
    {  }."_getResponder" = _getResponder /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."extractEvents" = extractEvents /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."injectGlobalResponderHandler" = injectGlobalResponderHandler /* Closure with env r1 = createEnvironment() */;
    ...
    // USED → r37 = globalThis.Array.prototype.slice.call(globalThis.Array.prototype.slice, ["ResponderEventPlugin", "ReactNativeBridgeEventPlugin"])
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 18, Reg8: 37>
    createEnvironment()[18] = globalThis.Array.prototype.slice.call(globalThis.Array.prototype.slice, ["ResponderEventPlugin", "ReactNativeBridgeEventPlugin"])
    ...
    if (HermesPropertyIterator({  }) === undefined) { /* jump to label_3789 */ }
    // LOOP → START (while)
    while (HermesPropertyIterator({  }).next() === undefined) {
        // ──────────────── Block 1 ──────────────── 
        ...
        if (HermesPropertyIterator({  }).next() === undefined) { /* jump to label_3789 */ }
        // ──────────────── Block 2 ──────────────── 
        ...
        // USED → r52 = {  }.hasOwnProperty
        // CODE → <Call2>: <Reg8: 52, Reg8: 52, Reg8: 50, Reg8: 44>
        // USED → r52 = {  }.hasOwnProperty({  }, HermesPropertyIterator({  }).next())
        // CODE → <Mov>: <Reg8: 43, Reg8: 54>
        r43 = false
        // CODE → <JmpFalse>: <Addr8: -31, Reg8: 52>  # Address: 00000e5d
        if (!{  }.hasOwnProperty({  }, HermesPropertyIterator({  }).next())) { /* jump to label_3677 */ }
        // ──────────────── Block 3 ──────────────── 
        // CODE → <GetByVal>: <Reg8: 52, Reg8: 50, Reg8: 44>
        // USED → r52 = {  }[HermesPropertyIterator({  }).next()]
        ...
        // USED → r53 = {  }.hasOwnProperty({  }, HermesPropertyIterator({  }).next())
        // CODE → <JmpFalse>: <Addr8: 17, Reg8: 53>  # Address: 00000e9e
        if (!{  }.hasOwnProperty({  }, HermesPropertyIterator({  }).next())) { /* jump to label_3742 */ }
        // ──────────────── Block 4 ──────────────── 
        // CODE → <GetByVal>: <Reg8: 53, Reg8: 51, Reg8: 44>
        // USED → r53 = {  }[HermesPropertyIterator({  }).next()]
        // CODE → <Mov>: <Reg8: 43, Reg8: 54>
        r43 = false
        // CODE → <Mov>: <Reg8: 42, Reg8: 52>
        r42 = {  }[HermesPropertyIterator({  }).next()]
        // CODE → <JStrictEqual>: <Addr8: -61, Reg8: 53, Reg8: 52>  # Address: 00000e5d
        if ({  }[HermesPropertyIterator({  }).next()] === {  }[HermesPropertyIterator({  }).next()]) { /* jump to label_3677 */ }
        // ──────────────── Block 5 ──────────────── 
        // CODE → <GetByVal>: <Reg8: 53, Reg8: 51, Reg8: 44>
        // USED → r53 = {  }[HermesPropertyIterator({  }).next()]
        // CODE → <JmpTrue>: <Addr8: 14, Reg8: 53>  # Address: 00000eb0
        if ({  }[HermesPropertyIterator({  }).next()]) { /* jump to label_3760 */ }
        // ──────────────── Block 6 ──────────────── 
        // CODE → <PutByVal>: <Reg8: 51, Reg8: 44, Reg8: 52>
        {  }[HermesPropertyIterator({  }).next()] = {  }[HermesPropertyIterator({  }).next()];
    ...
    // USED → r42 = "EventPluginRegistry: Cannot inject two different event plugins using the same name, `" + HermesPropertyIterator({  }).next() + "`."
    // CODE → <Call2>: <Reg8: 42, Reg8: 43, Reg8: 2, Reg8: 42>
    // USED → r42 = globalThis.Error(undefined, "EventPluginRegistry: Cannot inject two different event plugins using the same name, `" + HermesPropertyIterator({  }).next() + "`.")
    // CODE → <Throw>: <Reg8: 42>
    throw globalThis.Error(undefined, "EventPluginRegistry: Cannot inject two different event plugins using the same name, `" + HermesPropertyIterator({  }).next() + "`.");
    // ──────────────── Block 8 ──────────────── 
    ...
    r9 = globalThis.nativeFabricUIManager.registerEventHandler(undefined, dispatchEvent /* Closure with env r1 = createEnvironment() */)
    // ──────────────── Block 14 ──────────────── 
    ...
    createEnvironment()[53] = !!globalThis.RN$enableMicrotasksInReact
    ...
    // USED → r41 = {  }.injection.injectGlobalResponderHandler
    // CODE → <NewObject>: <Reg8: 40>
    // USED → r40 = {  }
    ...
    {  }."onChange" = onChange /* Closure with env r1 = createEnvironment() */;
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = {  }.injection.injectGlobalResponderHandler({  }.injection, {  })
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.element")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 55, Reg8: 40>
    createEnvironment()[55] = globalThis.Symbol.for(globalThis.Symbol, "react.element")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.portal")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 56, Reg8: 40>
    createEnvironment()[56] = globalThis.Symbol.for(globalThis.Symbol, "react.portal")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.fragment")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 57, Reg8: 40>
    createEnvironment()[57] = globalThis.Symbol.for(globalThis.Symbol, "react.fragment")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.strict_mode")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 58, Reg8: 40>
    createEnvironment()[58] = globalThis.Symbol.for(globalThis.Symbol, "react.strict_mode")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.profiler")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 59, Reg8: 40>
    createEnvironment()[59] = globalThis.Symbol.for(globalThis.Symbol, "react.profiler")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.provider")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 60, Reg8: 40>
    createEnvironment()[60] = globalThis.Symbol.for(globalThis.Symbol, "react.provider")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.consumer")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 61, Reg8: 40>
    createEnvironment()[61] = globalThis.Symbol.for(globalThis.Symbol, "react.consumer")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.context")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 62, Reg8: 40>
    createEnvironment()[62] = globalThis.Symbol.for(globalThis.Symbol, "react.context")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.forward_ref")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 63, Reg8: 40>
    createEnvironment()[63] = globalThis.Symbol.for(globalThis.Symbol, "react.forward_ref")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.suspense")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 64, Reg8: 40>
    createEnvironment()[64] = globalThis.Symbol.for(globalThis.Symbol, "react.suspense")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.suspense_list")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 65, Reg8: 40>
    createEnvironment()[65] = globalThis.Symbol.for(globalThis.Symbol, "react.suspense_list")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // USED → r40 = "react.memo"
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.memo")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 66, Reg8: 40>
    createEnvironment()[66] = globalThis.Symbol.for(globalThis.Symbol, "react.memo")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // USED → r40 = "react.lazy"
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.lazy")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 67, Reg8: 40>
    createEnvironment()[67] = globalThis.Symbol.for(globalThis.Symbol, "react.lazy")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = globalThis.Symbol.for(globalThis.Symbol, "react.scope")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = globalThis.Symbol.for(globalThis.Symbol, "react.debug_trace_mode")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    // USED → r40 = globalThis.Symbol.for(globalThis.Symbol, "react.offscreen")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 68, Reg8: 40>
    createEnvironment()[68] = globalThis.Symbol.for(globalThis.Symbol, "react.offscreen")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = globalThis.Symbol.for(globalThis.Symbol, "react.legacy_hidden")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = globalThis.Symbol.for(globalThis.Symbol, "react.cache")
    // CODE → <TryGetById>: <Reg8: 42, Reg8: 0, UInt8: 38, string_id: 52>  # String: 'Symbol' (Identifier)
    // USED → r42 = globalThis.Symbol
    // CODE → <GetByIdShort>: <Reg8: 41, Reg8: 42, UInt8: 39, string_id: 39>  # String: 'for' (Identifier)
    // USED → r41 = globalThis.Symbol.for
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = globalThis.Symbol.for(globalThis.Symbol, "react.tracing_marker")
    ...
    // CODE → <Call2>: <Reg8: 40, Reg8: 41, Reg8: 42, Reg8: 40>
    r40 = globalThis.Symbol.for(globalThis.Symbol, "react.client.reference")
    // CODE → <NewArray>: <Reg8: 40, UInt16: 0>
    // USED → r40 = []
    ...
    // USED → r38 = globalThis.Error(undefined, "str_3625")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 89, Reg8: 38>
    createEnvironment()[89] = globalThis.Error(undefined, "str_3625")
    // CODE → <TryGetById>: <Reg8: 39, Reg8: 0, UInt8: 13, string_id: 14>  # String: 'Error' (Identifier)
    // USED → r39 = globalThis.Error
    ...
    // USED → r38 = "str_6775"
    // CODE → <Call2>: <Reg8: 38, Reg8: 39, Reg8: 2, Reg8: 38>
    // USED → r38 = globalThis.Error(undefined, "str_6775")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 90, Reg8: 38>
    createEnvironment()[90] = globalThis.Error(undefined, "str_6775")
    ...
    {  }."then" = then /* Closure with env r1 = createEnvironment() */;
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 91, Reg8: 38>
    createEnvironment()[91] = {  }
    ...
    // CODE → <PutNewOwnByIdShort>: <Reg8: 20, Reg8: 36, string_id: 242>  # String: 'useCallback' (Identifier)
    {  }."useCallback" = useCallback /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutNewOwnByIdShort>: <Reg8: 20, Reg8: 31, string_id: 228>  # String: 'useContext' (Identifier)
    {  }."useContext" = readContext /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutNewOwnByIdShort>: <Reg8: 20, Reg8: 35, string_id: 243>  # String: 'useEffect' (Identifier)
    {  }."useEffect" = mountEffect /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useImperativeHandle" = useImperativeHandle /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useLayoutEffect" = useLayoutEffect /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useInsertionEffect" = useInsertionEffect /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useMemo" = useMemo /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useReducer" = useReducer /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useRef" = useRef /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useState" = useState /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutNewOwnById>: <Reg8: 20, Reg8: 23, string_id: 24567>  # String: 'useDebugValue' (Identifier)
    {  }."useDebugValue" = mountDebugValue /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useDeferredValue" = useDeferredValue /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useTransition" = useTransition /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useSyncExternalStore" = useSyncExternalStore /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useId" = useId /* Closure with env r1 = createEnvironment() */;
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 116, Reg8: 20>
    createEnvironment()[116] = {  }
    // CODE → <NewObject>: <Reg8: 20>
    // USED → r20 = {  }
    // CODE → <PutNewOwnById>: <Reg8: 20, Reg8: 31, string_id: 20330>  # String: 'readContext' (Identifier)
    {  }."readContext" = readContext /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useSyncExternalStore" = updateSyncExternalStore /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutNewOwnById>: <Reg8: 20, Reg8: 21, string_id: 24594>  # String: 'useId' (Identifier)
    {  }."useId" = updateId /* Closure with env r1 = createEnvironment() */;
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 117, Reg8: 20>
    createEnvironment()[117] = {  }
    // CODE → <NewObject>: <Reg8: 20>
    // USED → r20 = {  }
    // CODE → <PutNewOwnById>: <Reg8: 20, Reg8: 31, string_id: 20330>  # String: 'readContext' (Identifier)
    {  }."readContext" = readContext /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."useReducer" = rerenderReducer /* Closure with env r1 = createEnvironment() */;
    // CODE → <PutNewOwnByIdShort>: <Reg8: 20, Reg8: 24, string_id: 244>  # String: 'useRef' (Identifier)
    {  }."useRef" = updateRef /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."isMounted" = isMounted /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."enqueueSetState" = enqueueSetState /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."enqueueReplaceState" = enqueueReplaceState /* Closure with env r1 = createEnvironment() */;
    ...
    {  }."enqueueForceUpdate" = enqueueForceUpdate /* Closure with env r1 = createEnvironment() */;
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 119, Reg8: 20>
    createEnvironment()[119] = {  }
    ...
    // USED → r21 = createThis(prototype=globalThis.WeakMap.prototype, constructor=globalThis.WeakMap)
    // CODE → <Mov>: <Reg8: 57, Reg8: 21>
    r57 = createThis(prototype=globalThis.WeakMap.prototype, constructor=globalThis.WeakMap)
    // CODE → <Construct>: <Reg8: 20, Reg8: 20, UInt8: 1>
    // USED → r20 = new globalThis.WeakMap(r19)
    // CODE → <SelectObject>: <Reg8: 20, Reg8: 21, Reg8: 20>
    // USED → r20 = createThis(prototype=globalThis.WeakMap.prototype, constructor=globalThis.WeakMap)[new globalThis.WeakMap(r19)]
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 120, Reg8: 20>
    createEnvironment()[120] = createThis(prototype=globalThis.WeakMap.prototype, constructor=globalThis.WeakMap)[new globalThis.WeakMap(r19)]
    ...
    // USED → r17 = "str_6991"
    // CODE → <Call2>: <Reg8: 17, Reg8: 18, Reg8: 2, Reg8: 17>
    // USED → r17 = globalThis.Error(undefined, "str_6991")
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 122, Reg8: 17>
    createEnvironment()[122] = globalThis.Error(undefined, "str_6991")
    ...
    goto label_5675;
    // LOOP → START (while)
    while ("function" === typeof globalThis.WeakMap) {
        // ──────────────── Block 24 ──────────────── 
    ...
    goto label_5723;
    // LOOP → START (while)
    while (r12.findFiberByHostInstance) {
        // ──────────────── Block 27 ──────────────── 
        ...
        // USED → r12 = createThis(prototype=globalThis.Map.prototype, constructor=globalThis.Map)
        // CODE → <Mov>: <Reg8: 57, Reg8: 12>
        r57 = createThis(prototype=globalThis.Map.prototype, constructor=globalThis.Map)
        // CODE → <Construct>: <Reg8: 10, Reg8: 10, UInt8: 1>
        // USED → r10 = new globalThis.Map("undefined")
        // CODE → <SelectObject>: <Reg8: 10, Reg8: 12, Reg8: 10>
        // USED → r10 = createThis(prototype=globalThis.Map.prototype, constructor=globalThis.Map)[new globalThis.Map("undefined")]
        // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 168, Reg8: 10>
        createEnvironment()[168] = createThis(prototype=globalThis.Map.prototype, constructor=globalThis.Map)[new globalThis.Map("undefined")]
        ...
        r12.findFiberByHostInstance = getInstanceFromNode /* Closure with env r1 = createEnvironment() */;
        ...
        {  }."getInspectorDataForInstance" = getInspectorDataForInstance /* Closure with env r1 = createEnvironment() */;
        ...
        {  }."getInspectorDataForViewTag" = getInspectorDataForViewTag /* Closure with env r1 = createEnvironment() */;
        ...
        {  }."getInspectorDataForViewAtPoint" = function_850 /* Closure with env r1 = createEnvironment() */.bind(function_850 /* Closure with env r1 = createEnvironment() */, null, findNodeHandle /* Closure with env r1 = createEnvironment() */);
        ...
        {  }."rendererPackageName" = r12.rendererPackageName;
        ...
        {  }."rendererConfig" = r12.rendererConfig;
        ...
        {  }."currentDispatcherRef" = r18(undefined, r19[1]).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
    ...
    {  }."findFiberByHostInstance" = emptyFindFiberByHostInstance /* Closure with env r1 = createEnvironment() */;
    ...
    if (!globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__.supportsFiber) { /* jump to label_6205 */ }
    // ──────────────── Block 32 ──────────────── 
    ...
    // USED → r7 = globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__.inject(globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__, {  })
    // CODE → <StoreToEnvironment>: <Reg8: 1, UInt8: 31, Reg8: 7>
    createEnvironment()[31] = globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__.inject(globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__, {  })
    ...
    while (true) {
        ...
        r3.createPortal = function_852 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.dispatchCommand = function_853 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.findHostInstance_DEPRECATED = function_854 /* Closure with env r1 = createEnvironment() */;
        // CODE → <PutById>: <Reg8: 3, Reg8: 5, UInt8: 10, string_id: 18319>  # String: 'findNodeHandle' (Identifier)
        r3.findNodeHandle = findNodeHandle /* Closure with env r1 = createEnvironment() */;
        // CODE → <PutById>: <Reg8: 3, Reg8: 4, UInt8: 11, string_id: 14222>  # String: 'getInspectorDataForInstance' (Identifier)
        r3.getInspectorDataForInstance = getInspectorDataForInstance /* Closure with env r1 = createEnvironment() */;
        ...
        r3.getNodeFromInternalInstanceHandle = function_855 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.getPublicInstanceFromInternalInstanceHandle = function_856 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.isChildPublicInstance = function_857 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.render = function_858 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.sendAccessibilityEvent = function_859 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.stopSurface = function_860 /* Closure with env r1 = createEnvironment() */;
        ...
        r3.unmountComponentAtNode = function_862 /* Closure with env r1 = createEnvironment() */;
        // CODE → <Ret>: <Reg8: 2>
        return undefined;
        // ──────────────── Block 33 ──────────────── 
        // CODE → <Catch>: <Reg8: 6>
    ...
    // USED → r0 = globalThis.Error(undefined, "Expected ReactFiberErrorDialog.showErrorDialog to be a function.")
    // CODE → <Throw>: <Reg8: 0>
    throw globalThis.Error(undefined, "Expected ReactFiberErrorDialog.showErrorDialog to be a function.");
}