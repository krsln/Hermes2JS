function spreadFunctionArgsTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 4698>  # String: '__BC:Arrays/SpreadTests/spreadFunctionArgsTest/start' (String)
    ...
    // USED → r1 = undefined;
    // CODE → <CreateClosure>: <Reg8: 9, Reg8: 1, function_id: 12403>  # Function: [#12403 sum of 19 bytes]: 4 params @ offset 0x0023e3d7
    r9 = sum;
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4697>  # String: '__BC:Arrays/SpreadTests/spreadFunctionArgsTest/end' (String)
