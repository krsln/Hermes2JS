function ifTest(param0, param1) {
    ...
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 4730>  # String: '__BC:ControlFlow/IfTests/ifTest/start' (String)
    ...
    if (param1 > 10) {
        ...
        // CODE → <LoadConstString>: <Reg8: 3, string_id: 3372>  # String: '__BC:ControlFlow/IfTests/ifTest/branch-big' (String)
        ...
        // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
        // USED → r4 = globalThis.console.log;
        // CODE → <LoadConstString>: <Reg8: 3, string_id: 3050>  # String: 'big' (String)
        // USED → r3 = "big";
        // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
        ...
        if (param1 > 5) {
            ...
            // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r4 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 3, string_id: 4723>  # String: '__BC:ControlFlow/IfTests/ifTest/branch-medium' (String)
            ...
            // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
            // USED → r4 = globalThis.console.log;
            // CODE → <LoadConstString>: <Reg8: 3, string_id: 11045>  # String: 'medium' (Identifier)
            // USED → r3 = "medium";
            // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
            ...
            if (param1 === 0) {
                ...
                // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
                // USED → r4 = globalThis.console.log;
                // CODE → <LoadConstString>: <Reg8: 3, string_id: 4725>  # String: '__BC:ControlFlow/IfTests/ifTest/branch-zero' (String)
                ...
                // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
                // USED → r4 = globalThis.console.log;
                // CODE → <LoadConstString>: <Reg8: 3, string_id: 588>  # String: 'zero' (String)
                // USED → r3 = "zero";
                // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
                ...
                // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
                // USED → r4 = globalThis.console.log;
                // CODE → <LoadConstString>: <Reg8: 3, string_id: 4724>  # String: '__BC:ControlFlow/IfTests/ifTest/branch-small' (String)
                ...
                // CODE → <GetByIdShort>: <Reg8: 4, Reg8: 5, UInt8: 1, string_id: 177>  # String: 'log' (Identifier)
                // USED → r4 = globalThis.console.log;
                // CODE → <LoadConstString>: <Reg8: 3, string_id: 9419>  # String: 'small' (Identifier)
                // USED → r3 = "small";
                // CODE → <Call2>: <Reg8: 3, Reg8: 4, Reg8: 5, Reg8: 3>
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 4727>  # String: '__BC:ControlFlow/IfTests/ifTest/end' (String)
