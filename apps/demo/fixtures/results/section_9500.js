function nestedTemplateTest(param0, param1, param2) {
    ...
    // USED → r5 = (param1 + param2 <= 10) ? param1 + param2 : globalThis.HermesInternal.concat.call("big (", param1 + param2, ")");
    ...
    // USED → r5 = globalThis.HermesInternal.concat.call("sum is ", (param1 + param2 <= 10) ? param1 + param2 : globalThis.HermesInternal.concat.call("big (", param1 + param2, ")"));
    ...
    r3 = globalThis.console.log(globalThis.HermesInternal.concat.call("sum is ", (param1 + param2 <= 10) ? param1 + param2 : globalThis.HermesInternal.concat.call("big (", param1 + param2, ")")))
    // CODE → <TryGetById>: <Reg8: 4, Reg8: 2, UInt8: 0, string_id: 108>  # String: 'console' (Identifier)
    // USED → r4 = globalThis.console;
    // CODE → <GetByIdShort>: <Reg8: 3, Reg8: 4, UInt8: 1, string_id: 178>  # String: 'log' (Identifier)
    // USED → r3 = globalThis.console.log;
