function nestedTemplateTest(param1, param2) {
    ...
    if (r5 > 10) {
        ...
        // USED → r5 = globalThis.HermesInternal.concat.call("big (", r7, ")");
    } else {
        // ──────────────── Block 1 ──────────────── 
        ...
        r5 = globalThis.HermesInternal.concat.call("small (", r8, ")")
    }
    // ──────────────── Block 3 ──────────────── 
    // CODE → <TryGetById>: <Reg8: 3, Reg8: 2, UInt8: 2, string_id: 10>  # String: 'HermesInternal' (Identifier)
    // USED → r3 = globalThis.HermesInternal;
    ...
    // USED → r5 = globalThis.HermesInternal.concat.call("sum is ", r5);
