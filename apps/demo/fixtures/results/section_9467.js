function makeSound(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 3, string_id: 3437>  # String: '__BC:Classes/ClassTests/Animal/makeSound' (String)
    ...
    // USED → r3 = this.name;
    // CODE → <GetById>: <Reg8: 2, Reg8: 1, UInt8: 3, string_id: 11460>  # String: 'sound' (Identifier)
    // USED → r2 = this.sound;
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 2518>  # String: 'says' (String)
    // USED → r1 = "says";
