function create(param0, param1) {
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 559>  # String: '__BC:Classes/ClassTests/Dog/static-create' (String)
    ...
    // CODE → <GetByIdShort>: <Reg8: 0, Reg8: 3, UInt8: 3, string_id: 207>  # String: 'prototype' (Identifier)
    ...
    r5 = param1
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 3473>  # String: 'Mixed' (String)
    r4 = "Mixed"
