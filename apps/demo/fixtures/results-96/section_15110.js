function makeSound(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 2, string_id: 3905>  # String: '__BC:Classes/ClassTests/Animal/makeSound' (String)
    ...
    // USED → r2 = this.name;
    // CODE → <GetById>: <Reg8: 1, Reg8: 0, UInt8: 4, string_id: 11417>  # String: 'sound' (Identifier)
    // USED → r1 = this.sound;
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 2340>  # String: 'says' (String)
    // USED → r0 = "says";
