function nestedLoopTest(param0) {
    ...
    // CODE → <LoadConstString>: <Reg8: 1, string_id: 4568>  # String: '__BC:ControlFlow/NestedTests/nestedLoopTest/start' (String)
    ...
    // USED → r6 = 4;
    // CODE → <LoadConstString>: <Reg8: 5, string_id: 4563>  # String: '__BC:ControlFlow/NestedTests/nestedLoopTest/deep-if' (String)
    // USED → r5 = "__BC:ControlFlow/NestedTests/nestedLoopTest/deep-if";
    // CODE → <LoadConstString>: <Reg8: 4, string_id: 1504>  # String: 'nested' (String)
    // USED → r4 = "nested";
    ...
    while (true) {
        ...
        while (0 !== 1) {
            ...
            if (0 === 2) {
                // ──────────────── Block 4 ──────────────── 
                // CODE → <TryGetById>: <Reg8: 13, Reg8: 0, UInt8: 1, string_id: 100>  # String: 'console' (Identifier)
                // USED → r13 = globalThis.console;
                // CODE → <GetByIdShort>: <Reg8: 12, Reg8: 13, UInt8: 2, string_id: 91>  # String: 'log' (Identifier)
    ...
    // CODE → <LoadConstString>: <Reg8: 0, string_id: 4565>  # String: '__BC:ControlFlow/NestedTests/nestedLoopTest/end' (String)
