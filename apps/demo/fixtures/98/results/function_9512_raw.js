function defaultWithRestTest() {
    ...
    if (param1 !== undefined) goto label_12;
    // ──────────────── Block 1 ──────────────── 
    // CODE → addr:  9 | <LoadConstUInt8>: <Reg8: 6, UInt8: 1>
    // USED → r6 = 1;
    // ──────────────── Block 2 ──────────────── 
    // CODE → addr: 12 | <LoadConstUInt8>: <Reg8: 9, UInt8: 1>
    r9 = 1
    // CODE → addr: 15 | <CallBuiltin>: <Reg8: 5, UInt8: 47, UInt8: 2>  # Built-in function: [#47 HermesBuiltin_copyRestArgs]
    r5 = HermesBuiltin_copyRestArgs(r9, r8)
