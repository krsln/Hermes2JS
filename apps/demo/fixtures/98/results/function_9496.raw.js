function setTest() {
    ...
    r5 = r4
    // CODE → addr:132 | <JStrictEqual>: <Addr8: 29, Reg8: 5, Reg8: 0>  # Address: 000000a1
    ...
    // CODE → addr:173 | <CallBuiltin>: <Reg8: 2, UInt8: 48, UInt8: 4>  # Built-in function: [#48 HermesBuiltin_arraySpread]
    r2 = HermesBuiltin_arraySpread(r11, r10, r9, r8)
