function privateStaticTest() {
    ...
    // CODE → addr: 45 | <CallBuiltin>: <Reg8: 6, UInt8: 44, UInt8: 2>  # Built-in function: [#44 HermesBuiltin_throwTypeError]
    r6 = HermesBuiltin_throwTypeError(r13, r12)
    // ──────────────── Block 2 ──────────────── 
    ...
    r13 = "Trying to call a non-function"
    // CODE → addr:145 | <CallBuiltin>: <Reg8: 6, UInt8: 44, UInt8: 2>  # Built-in function: [#44 HermesBuiltin_throwTypeError]
    r6 = HermesBuiltin_throwTypeError(r13, r12)
    // ──────────────── Block 5 ──────────────── 
    ...
    // CODE → addr:391 | <CallBuiltin>: <Reg8: 3, UInt8: 44, UInt8: 2>  # Built-in function: [#44 HermesBuiltin_throwTypeError]
    r3 = HermesBuiltin_throwTypeError(r13, r12)
    // ──────────────── Block 8 ──────────────── 
    // CODE → addr:395 | <LoadConstString>: <Reg8: 13, string_id: 2847>  # String: 'Cannot initialize private field twice.' (String)
    r13 = "Cannot initialize private field twice."
    // CODE → addr:399 | <CallBuiltin>: <Reg8: 3, UInt8: 44, UInt8: 2>  # Built-in function: [#44 HermesBuiltin_throwTypeError]
    r3 = HermesBuiltin_throwTypeError(r13, r12)
}