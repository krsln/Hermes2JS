function spreadArrayTest() {
    ...
    r11 = 0
    // CODE → addr: 42 | <CallBuiltin>: <Reg8: 11, UInt8: 48, UInt8: 4>  # Built-in function: [#48 HermesBuiltin_arraySpread]
    r11 = HermesBuiltin_arraySpread(r13, r12, r11, r10)
    // CODE → addr: 46 | <NewArrayWithBuffer>: <Reg8: 12, UInt16: 3, UInt16: 3, UInt16: 11325>  # Array: [4, 5, 6]
    r12 = [4, 5, 6]
    // CODE → addr: 54 | <Mov>: <Reg8: 13, Reg8: 0>
    r13 = r0
    // CODE → addr: 57 | <CallBuiltin>: <Reg8: 4, UInt8: 48, UInt8: 4>  # Built-in function: [#48 HermesBuiltin_arraySpread]
    r4 = HermesBuiltin_arraySpread(r13, r12, r11, r10)
    ...
    r11 = 1
    // CODE → addr: 97 | <CallBuiltin>: <Reg8: 4, UInt8: 48, UInt8: 4>  # Built-in function: [#48 HermesBuiltin_arraySpread]
    r4 = HermesBuiltin_arraySpread(r13, r12, r11, r10)
