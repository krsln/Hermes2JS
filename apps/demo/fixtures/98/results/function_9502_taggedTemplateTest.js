function taggedTemplateTest(param1) {
    ...
    r10 = 1
    // CODE → addr: 38 | <CallBuiltin>: <Reg8: 5, UInt8: 41, UInt8: 5>  # Built-in function: [#41 HermesBuiltin_getTemplateObject]
    r5 = HermesBuiltin_getTemplateObject(r10, r9, r8, r7, r6)
