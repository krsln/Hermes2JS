function isRenderConsistentWithExternalStores(param0, param1) {
    ...
    while (!(param1.flags & 16384)) {
        ...
        if (!(param1.flags & 16384)) goto label_158;
        // ──────────────── Block 2 ──────────────── 
        ...
        goto label_29;
        // LOOP → START (while)
        while (getEnvironment(0)[73].call(undefined, param1.updateQueue.stores[0].getSnapshot.call(undefined), param1.updateQueue.stores[0].value)) {
            // ──────────────── Block 5 ──────────────── 
