function _request(param0, param1, param2) {
    ...
    if (getEnvironment(1)[7].default(undefined, this.defaults, {  }).transitional !== undefined) {
        // ──────────────── Block 8 ──────────────── 
    ...
    // USED → r2 = null;
    if (getEnvironment(1)[7].default(undefined, this.defaults, {  }).paramsSerializer != null) {
        // ──────────────── Block 10 ──────────────── 
        ...
        if (getEnvironment(1)[3].default.isFunction(getEnvironment(1)[3].default, getEnvironment(1)[7].default(undefined, this.defaults, {  }).paramsSerializer)) {
            // ──────────────── Block 12 ──────────────── 
            // CODE → <NewObject>: <Reg8: 2>
            // USED → r2 = {  };
    ...
    if (getEnvironment(1)[7].default(undefined, this.defaults, {  }).allowAbsoluteUrls === undefined) {
        // ──────────────── Block 14 ──────────────── 
        // CODE → <GetById>: <Reg8: 2, Reg8: 8, UInt8: 2, string_id: 14042>  # String: 'defaults' (Identifier)
        // USED → r2 = this.defaults;
    ...
    if (getEnvironment(1)[7].default(undefined, this.defaults, {  }).headers) {
        // ──────────────── Block 22 ──────────────── 
    ...
    if (createEnvironment()[3]) {
        ...
        // CODE → <Mov>: <Reg8: 9, Reg8: 4>
        // USED → r9 = 0;
        if (0 < [getEnvironment(1)[6].default.bind(getEnvironment(1)[6].default, this), undefined].length) {
            // ──────────────── Block 27 ──────────────── 
